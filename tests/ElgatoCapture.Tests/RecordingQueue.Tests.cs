...
static partial class Program
{
    private static Task RecordingVideoQueues_FailExplicitlyInsteadOfEvictingFrames()
    {
        ...
        AssertContains(libAvSource, "UpdateMaxDepth(ref _videoQueueMaxDepth, depth);");
        ...
        AssertContains(libAvSource, "UpdateMaxDepth(ref _gpuQueueMaxDepth, depth);");
        ...
        AssertContains(libAvSource, "UpdateMaxDepth(ref _cudaQueueMaxDepth, depth);");
        ...
        AssertDoesNotContain(libAvSource, "UpdateMaxDepth(ref _gpuQueueMaxDepth, Interlocked.Increment(ref _gpuQueueDepth))");
        AssertDoesNotContain(libAvSource, "UpdateMaxDepth(ref _cudaQueueMaxDepth, Interlocked.Increment(ref _cudaQueueDepth))");

...
static partial class Program
{
    ...
    private static Task DiagnosticsSnapshotRefresh_IsSerializedForRecordingResponses()
    {
        ...
        AssertContains(diagnosticsText, "snapshot.FlashbackVideoSequenceGaps > 0");
        AssertContains(diagnosticsText, "snapshot.FlashbackGpuFramesDropped > 0");
        AssertContains(diagnosticsText, "snapshot.FlashbackVideoBackpressureMaxWaitMs >= FlashbackRecordingBackpressureWarningMs");

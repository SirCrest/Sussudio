...
public class FlashbackPlaybackMarkersTests
{
    ...
    private static string ReadFlashbackPlaybackControllerPlaybackSource()
    {
        var parts = new[]
        {
            ...
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.PlaybackCadenceMetrics.cs"),
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.PlaybackDecodeMetrics.cs"),
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.MetricsCollection.cs"),
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.MetricReset.cs"),
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.SeekCapTelemetry.cs"),
            ...
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.SeekDisplayFrames.cs"),
            ...
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.PlaybackSegmentSwitch.cs"),
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.PlaybackTiming.cs"),
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.PlaybackPtsCadence.cs"),
            ...
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.CommandMetrics.cs"),
            ...
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.ThreadCommandDispatch.cs"),
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.ThreadExit.cs"),
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.ThreadLifecycle.cs"),
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.ThreadStartLifecycle.cs"),
            ReadRepoFile("Sussudio/Services/Flashback/FlashbackPlaybackController.ThreadStopLifecycle.cs"),

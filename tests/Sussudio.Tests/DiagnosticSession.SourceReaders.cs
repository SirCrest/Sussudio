static partial class Program
{
    ...
    private static string ReadDiagnosticSessionFlashbackMetricsSource()
        => ReadNormalizedSourceFiles(
            ...
            "tools/Common/DiagnosticSessionFlashbackMetrics.PlaybackSession.Stages.Model.cs",
            ...
            "tools/Common/DiagnosticSessionFlashbackMetrics.PlaybackResult.Stages.Model.cs",
    ...
    private static string ReadDiagnosticSessionResultFormatterSource()
        => ReadNormalizedSourceFiles(
            ...
            "tools/Common/DiagnosticSessionResultFormatter.FlashbackPlayback.OnePercentLow.cs",

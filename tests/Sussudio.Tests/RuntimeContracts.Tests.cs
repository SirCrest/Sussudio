...
internal static class RuntimeContractSource
{
    ...
    public static string ReadAutomationSnapshotFormatterSource()
        => ReadSourceFamily(new[]
        {
            ...
            "tools/Common/AutomationSnapshotFormatter.Flashback.Encoding.Status.cs",
            "tools/Common/AutomationSnapshotFormatter.Flashback.Encoding.Health.cs",
            ...
            "tools/Common/AutomationSnapshotFormatter.MjpegTiming.Decode.cs",
            "tools/Common/AutomationSnapshotFormatter.MjpegTiming.Pipeline.cs",
    ...
    public static string ReadSsctlSnapshotFormatterSource()
        => ReadSourceFamily(new[]
        {
            ...
            "tools/ssctl/Formatters.Snapshot.Flashback.Encoding.Status.cs",
            "tools/ssctl/Formatters.Snapshot.Flashback.Encoding.Health.cs",
            "tools/ssctl/Formatters.Snapshot.Flashback.Export.cs",
            "tools/ssctl/Formatters.Snapshot.Flashback.Playback.Commands.cs",
            "tools/ssctl/Formatters.Snapshot.Flashback.Playback.Performance.cs",
            "tools/ssctl/Formatters.Snapshot.Mjpeg.cs",
            "tools/ssctl/Formatters.Snapshot.Mjpeg.Decode.cs",
            "tools/ssctl/Formatters.Snapshot.Mjpeg.Pipeline.cs",

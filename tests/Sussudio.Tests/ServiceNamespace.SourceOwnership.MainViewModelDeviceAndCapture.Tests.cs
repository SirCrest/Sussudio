...
static partial class Program
{
    private static void AssertServiceNamespaceMainViewModelDeviceAndCaptureSourceOwnership(string repoRoot)
    {
        ...
        AssertContains(mainViewModelDeviceFormatProbeControllerContextText, "namespace Sussudio.Controllers;");
        AssertContains(mainViewModelDeviceFormatProbeControllerContextText, "internal sealed class MainViewModelDeviceFormatProbeControllerContext");
        ...
        AssertContains(mainViewModelDeviceFormatProbeRetargetApplierContextText, "namespace Sussudio.Controllers;");
        AssertContains(mainViewModelDeviceFormatProbeRetargetApplierContextText, "internal sealed class MainViewModelDeviceFormatProbeRetargetApplierContext");
        ...
        AssertContains(
            ...
            + "\n" + File.ReadAllText(Path.Combine(repoRoot, "Sussudio", "Services", "Preview", "D3D11PreviewRenderer.FirstFrameNotifications.cs"))
            ...
            + "\n" + File.ReadAllText(Path.Combine(repoRoot, "Sussudio", "Services", "Preview", "D3D11PreviewRenderer.PanelComposition.cs")),

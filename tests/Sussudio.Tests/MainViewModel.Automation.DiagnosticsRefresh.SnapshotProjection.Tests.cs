static partial class Program
{
    ...
    private static void AssertDiagnosticsRefreshSnapshotProjectionOwnership(AutomationDiagnosticsHubSourceFamily diagnostics)
    {
        ...
        AssertContains(diagnostics.SnapshotProjectionFlatteningFlashbackRecordingText, "EncodingFailed = flashbackRecording.EncodingFailed,");
        AssertContains(diagnostics.SnapshotProjectionFlatteningFlashbackRecordingText, "StartupCacheOverBudget = flashbackRecording.StartupCache.OverBudget,");
        AssertContains(diagnostics.SnapshotProjectionFlatteningFlashbackRecordingText, "VideoQueueCapacity = flashbackRecording.Queues.VideoQueueCapacity,");
        AssertContains(diagnostics.SnapshotProjectionFlatteningFlashbackRecordingText, "GpuQueueLastRejectReason = flashbackRecording.Queues.GpuQueueLastRejectReason,");
        AssertContains(diagnostics.SnapshotProjectionFlatteningFlashbackRecordingText, "AudioQueueCapacity = flashbackRecording.Queues.AudioQueueCapacity");
        AssertContains(diagnostics.SnapshotProjectionFlatteningText, "FlashbackEncodingFailed = flashbackRecordingFlattening.EncodingFailed,");
        AssertContains(diagnostics.SnapshotProjectionFlatteningText, "FlashbackVideoQueueCapacity = flashbackRecordingFlattening.VideoQueueCapacity,");
        AssertContains(diagnostics.SnapshotProjectionFlatteningText, "FlashbackAudioQueueCapacity = flashbackRecordingFlattening.AudioQueueCapacity,");
        ...
        AssertDoesNotContain(diagnostics.SnapshotProjectionFlatteningText, "FlashbackEncodingFailed = flashbackRecording.EncodingFailed,");
        AssertDoesNotContain(diagnostics.SnapshotProjectionFlatteningText, "FlashbackVideoQueueCapacity = flashbackRecording.Queues.VideoQueueCapacity,");
        AssertDoesNotContain(diagnostics.SnapshotProjectionFlatteningText, "FlashbackAudioQueueCapacity = flashbackRecording.Queues.AudioQueueCapacity,");

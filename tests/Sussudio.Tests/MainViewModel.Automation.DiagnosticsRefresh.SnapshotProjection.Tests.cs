static partial class Program
{
    private static void AssertDiagnosticsRefreshSnapshotProjectionOwnership(AutomationDiagnosticsHubSourceFamily diagnostics)
    {
        ...
        AssertContains(diagnostics.SnapshotProjectionPreviewD3DText, "private static PreviewD3DFrameFlowProjection BuildPreviewD3DFrameFlowProjection(");
        AssertContains(diagnostics.SnapshotProjectionPreviewD3DText, "LastRenderedPipelineLatencyMs = previewRuntime.D3DLastRenderedPipelineLatencyMs,");
        AssertContains(diagnostics.SnapshotProjectionPreviewD3DText, "RecentSlowFrames = previewRuntime.D3DRecentSlowFrames");
        ...
        AssertContains(diagnostics.SnapshotProjectionPreviewD3DText, "private static PreviewD3DFrameLatencyWaitProjection BuildPreviewD3DFrameLatencyWaitProjection(");
        AssertContains(diagnostics.SnapshotProjectionPreviewD3DText, "TimeoutCount = previewRuntime.D3DFrameLatencyWaitTimeoutCount,");
        AssertContains(diagnostics.SnapshotProjectionPreviewD3DText, "FrameStats = frameStats,");
        AssertContains(diagnostics.SnapshotProjectionPreviewD3DText, "private static PreviewD3DFrameStatsProjection BuildPreviewD3DFrameStatsProjection(");
        AssertContains(diagnostics.SnapshotProjectionPreviewD3DText, "RecentMissedRefreshCount = recentD3DMissedRefreshes,");

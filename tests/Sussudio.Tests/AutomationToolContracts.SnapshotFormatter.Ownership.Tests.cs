...
static partial class Program
{
    private static Task AutomationSnapshotFormatter_SourceOwnership_IsSplit()
    {
        ...
        var sharedFormatterPreviewD3DCpuTimingSource = ReadRepoFile("tools/Common/AutomationSnapshotFormatter.PreviewD3D.CpuTiming.cs");
        ...
        var sharedFormatterPreviewD3DFrameLatencyWaitSource = ReadRepoFile("tools/Common/AutomationSnapshotFormatter.PreviewD3D.FrameLatencyWait.cs");
        var sharedFormatterPreviewD3DFrameStatsSource = ReadRepoFile("tools/Common/AutomationSnapshotFormatter.PreviewD3D.FrameStats.cs");
        ...
        AssertDoesNotContain(sharedFormatterPreviewD3DSource, "D3D pipeline latency:");
        AssertDoesNotContain(sharedFormatterPreviewD3DSource, "D3D frame-latency wait:");
        AssertDoesNotContain(sharedFormatterPreviewD3DSource, "D3D DXGI stats:");
        AssertDoesNotContain(sharedFormatterPreviewD3DSource, "D3D Ownership:");
        ...
        AssertContains(sharedFormatterPreviewD3DCpuTimingSource, "private static void AppendPreviewD3DCpuTiming(StringBuilder builder, JsonElement snapshot)");
        AssertContains(sharedFormatterPreviewD3DCpuTimingSource, "D3D CPU timing:");
        AssertContains(sharedFormatterPreviewD3DFrameFlowSource, "private static void AppendPreviewD3DPipelineLatency(StringBuilder builder, JsonElement snapshot)");
        ...
        AssertContains(sharedFormatterPreviewD3DFrameFlowSource, "D3D pipeline latency:");
        AssertContains(sharedFormatterPreviewD3DFrameFlowSource, "D3D Ownership:");
        AssertContains(sharedFormatterPreviewD3DFrameLatencyWaitSource, "private static void AppendPreviewD3DFrameLatencyWait(StringBuilder builder, JsonElement snapshot)");
        AssertContains(sharedFormatterPreviewD3DFrameLatencyWaitSource, "D3D frame-latency wait:");
        AssertContains(sharedFormatterPreviewD3DFrameStatsSource, "private static void AppendPreviewD3DFrameStats(StringBuilder builder, JsonElement snapshot)");
        AssertContains(sharedFormatterPreviewD3DFrameStatsSource, "D3D DXGI stats:");

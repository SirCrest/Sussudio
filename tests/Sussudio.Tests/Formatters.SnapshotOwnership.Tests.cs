...
static partial class Program
{
    internal static Task SsctlFormatters_SnapshotSourceOwnership_IsSplit()
    {
        ...
        AssertContains(ssctlSnapshotRuntimeSource, "private static void AppendSnapshotCaptureCadenceSection(StringBuilder builder, JsonElement snapshot)");
        AssertContains(ssctlSnapshotRuntimeSource, "builder.AppendLine(\"== Capture Cadence ==\");");
        AssertContains(ssctlSnapshotRuntimeSource, "private static void AppendSnapshotAvSyncSection(StringBuilder builder, JsonElement snapshot)");
        AssertContains(ssctlSnapshotRuntimeSource, "var avSyncDrift = AutomationSnapshotFormatter.Get(snapshot, \"AvSyncCaptureDriftMs\", string.Empty);");
        AssertContains(ssctlSnapshotRuntimeSource, "builder.AppendLine(\"== AV Sync ==\");");
        ...
        AssertContains(ssctlSnapshotRuntimeSource, "private static void AppendSnapshotPreviewSection(StringBuilder builder, JsonElement snapshot)");
        AssertContains(ssctlSnapshotRuntimeSource, "var rendererMode = AutomationSnapshotFormatter.Get(snapshot, \"PreviewRendererMode\");");
        AssertContains(ssctlSnapshotRuntimeSource, "AppendSnapshotPreviewD3DSection(builder, snapshot);");
        AssertDoesNotContain(ssctlSnapshotRuntimeSource, "D3D CPU timing:");
        ...
        AssertContains(ssctlSnapshotRuntimeSource, "private static void AppendSnapshotSourceSection(StringBuilder builder, JsonElement snapshot)");
        AssertContains(ssctlSnapshotRuntimeSource, "builder.AppendLine(\"== Source ==\");");
        AssertContains(ssctlSnapshotRuntimeSource, "var sourceFrameRate = AutomationSnapshotFormatter.Get(snapshot, \"DetectedSourceFrameRate\", string.Empty);");

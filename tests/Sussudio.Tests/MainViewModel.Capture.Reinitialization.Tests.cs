...
static partial class Program
{
    private static Task MainViewModelPreviewLifecycle_LivesInController()
    {
        ...
        AssertContains(previewReinitializeControllerText, "Interlocked.Increment(ref _viewModel._previewReinitializeGeneration)");
        AssertContains(previewReinitializeControllerText, "await Task.Delay(PreviewReinitializeDebounceMs).ConfigureAwait(true);");
        AssertContains(previewReinitializeControllerText, "Volatile.Read(ref _viewModel._previewReinitializeGeneration) != reinitializeGeneration");
        ...
        AssertContains(previewReinitializeControllerText, "await _viewModel._previewReinitializeGate.WaitAsync();");
        AssertContains(previewReinitializeControllerText, "await _viewModel.NotifyPreviewReinitRequestedAsync(reason);");
        AssertContains(previewReinitializeControllerText, "await _viewModel.NotifyRendererStopAsync();");
        ...
        AssertContains(previewReinitializeControllerText, "_viewModel._previewReinitializeGate.Release();");

...
static partial class Program
{
    internal static Task DiagnosticSessionModels_AreSplitFromRunnerBehavior()
    {
        ...
        AssertContains(playbackCadenceResultText, "// Flashback playback 1% low sample-window summary.");
        AssertContains(playbackCadenceResultText, "public double FlashbackPlaybackOnePercentLowFpsAtEnd { get; init; }");
        ...
        AssertContains(playbackCadenceResultText, "// Flashback playback audio-master summary.");
        AssertContains(playbackCadenceResultText, "public long FlashbackPlaybackAudioMasterFallbacksAtEnd { get; init; }");
        ...
        AssertDoesNotContain(resultText, "FlashbackPlayback");
        AssertDoesNotContain(resultText, "PreviewScheduler");

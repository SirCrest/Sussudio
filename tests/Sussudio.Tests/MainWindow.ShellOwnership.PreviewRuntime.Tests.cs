...
static partial class Program
{
    ...
    private static Task PreviewRendererHostController_OwnsRuntimeState()
    {
        ...
        var previewRendererHostLifecycleText = ReadRepoFile("Sussudio/Controllers/PreviewRendererHostController.Lifecycle.cs").Replace("\r\n", "\n");
        var previewRendererHostD3dText = ReadRepoFile("Sussudio/Controllers/PreviewRendererHostController.D3D.cs").Replace("\r\n", "\n");
        var previewRendererHostCpuText = ReadRepoFile("Sussudio/Controllers/PreviewRendererHostController.Cpu.cs").Replace("\r\n", "\n");
        var previewRendererHostReinitText = ReadRepoFile("Sussudio/Controllers/PreviewRendererHostController.Reinit.cs").Replace("\r\n", "\n");

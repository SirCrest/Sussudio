static partial class Program
{
    private static void AssertDiagnosticsPreviewRuntimeProjectionOwnership(AutomationDiagnosticsHubSourceFamily diagnostics)
    {
        ...
        AssertContains(diagnostics.SnapshotProjectionFlatteningPreviewRuntimeText, "Frame = BuildPreviewRuntimeFrameFlattenedProjection(previewSummary),");
        ...
        AssertContains(diagnostics.SnapshotProjectionFlatteningPreviewRuntimeText, "Color = BuildPreviewRuntimeColorFlattenedProjection(previewSummary)");
        ...
        AssertContains(diagnostics.SnapshotProjectionFlatteningPreviewRuntimeFrameText, "EstimatedPipelineLatencyMs = previewSummary.EstimatedPipelineLatencyMs");
        ...
        AssertContains(diagnostics.SnapshotProjectionFlatteningPreviewRuntimeColorText, "AdapterColorMetadata = previewSummary.AdapterColorMetadata");

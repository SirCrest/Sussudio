...
static partial class Program
{
    ...
    private static RecordingQueueOverloadPolicySources ReadRecordingQueueOverloadPolicySources()
    {
        ...
        var flashbackBackendSource = ReadRepoFile("Sussudio/Services/Flashback/FlashbackBackendResources.ArtifactCleanup.cs")
        ...
        var captureSnapshotsSource = captureHealthSnapshotRootSource
            ...
            + "\n" + ReadRepoFile("Sussudio/Services/Capture/CaptureService.HealthSnapshotAssembler.Models.cs")

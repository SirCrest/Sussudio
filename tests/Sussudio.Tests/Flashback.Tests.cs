...
static partial class Program
{
    ...
    private static Task FlashbackPlaybackController_PlaybackTransitions_UseBestEffortAudioPreviewGuards()
    {
        ...
        AssertContains(sourceText, "private const double PlaybackAudioPrebufferTargetMs = 600.0;");
        AssertContains(sourceText, "private const double PlaybackAudioPrebufferDiscardThresholdMs = 900.0;");
        ...
        AssertContains(sourceText, "private const int PlaybackAudioPrebufferMaxFrames = 96;");
        AssertContains(sourceText, "var prebufferedFrames = new Queue<DecodedVideoFrame>(PlaybackAudioPrebufferMaxFrames);");

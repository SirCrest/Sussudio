...
static partial class Program
{
    private static string ReadCaptureSessionCoordinatorSource()
    {
        var parts = new[]
        {
            ...
            ReadRepoFile("Sussudio/Services/Capture/CaptureSessionCoordinator.Flashback.Status.cs").Replace("\r\n", "\n"),
            ReadRepoFile("Sussudio/Services/Capture/CaptureSessionCoordinator.Flashback.Playback.cs").Replace("\r\n", "\n"),
            ReadRepoFile("Sussudio/Services/Capture/CaptureSessionCoordinator.Flashback.Export.cs").Replace("\r\n", "\n"),
            ReadRepoFile("Sussudio/Services/Capture/CaptureSessionCoordinator.Flashback.Guards.cs").Replace("\r\n", "\n"),

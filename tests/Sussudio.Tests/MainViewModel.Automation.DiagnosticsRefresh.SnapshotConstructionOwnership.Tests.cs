static partial class Program
{
    private static void AssertDiagnosticsRefreshSnapshotConstructionOwnership(AutomationDiagnosticsHubSourceFamily diagnostics)
    {
        ...
        AssertContains(diagnostics.SnapshotProjectionCaptureFormatHdrRequestText, "private static CaptureFormatHdrRequestProjection BuildCaptureFormatHdrRequestProjection(");
        AssertContains(diagnostics.SnapshotProjectionCaptureFormatActualText, "private static CaptureFormatActualProjection BuildCaptureFormatActualProjection(");
        ...
        AssertContains(diagnostics.SnapshotProjectionCaptureFormatHdrRequestText, "private static CaptureFormatHdrRequestFlattenedProjection BuildCaptureFormatHdrRequestFlattenedProjection(");
        AssertContains(diagnostics.SnapshotProjectionCaptureFormatActualText, "private static CaptureFormatActualFlattenedProjection BuildCaptureFormatActualFlattenedProjection(");
        ...
        AssertContains(diagnostics.SnapshotProjectionRecordingIntegritySummaryText, "private static RecordingIntegritySummaryFlattenedProjection BuildRecordingIntegritySummaryFlattenedProjection(");
        AssertContains(diagnostics.SnapshotProjectionRecordingIntegrityVideoText, "private static RecordingIntegrityVideoFlattenedProjection BuildRecordingIntegrityVideoFlattenedProjection(");
        AssertContains(diagnostics.SnapshotProjectionRecordingIntegrityBackpressureText, "private static RecordingIntegrityBackpressureFlattenedProjection BuildRecordingIntegrityBackpressureFlattenedProjection(");
        AssertContains(diagnostics.SnapshotProjectionRecordingIntegrityAudioText, "private static RecordingIntegrityAudioFlattenedProjection BuildRecordingIntegrityAudioFlattenedProjection(");
        AssertContains(diagnostics.SnapshotProjectionRecordingIntegrityAvSyncText, "private static RecordingIntegrityAvSyncFlattenedProjection BuildRecordingIntegrityAvSyncFlattenedProjection(");

...
static partial class Program
{
    private static Task DiagnosticsSnapshotRefresh_IsSerializedForRecordingResponses()
    {
        ...
        AssertContains(diagnostics.SourceFamilyText, "exportLastProgressAgeMs >= FlashbackExportStallThresholdMs");
        ...
        AssertContains(diagnostics.SourceFamilyText, "\"flashback-temp-cache-pressure\"");
        AssertContains(diagnostics.SourceFamilyText, "snapshot.FlashbackStartupCacheOverBudget");
        AssertContains(diagnostics.SourceFamilyText, "snapshot.FlashbackTempDriveFreeBytes < FlashbackTempDriveLowFreeBytes");
        ...
        AssertContains(diagnostics.SourceFamilyText, "\"flashback-encoding-failed\"");
        AssertContains(diagnostics.SourceFamilyText, "snapshot.FlashbackEncodingFailed");
        AssertContains(diagnostics.SourceFamilyText, "Flashback encoder failed: type={snapshot.FlashbackEncodingFailureType ?? \"Unknown\"}");
        AssertContains(diagnostics.SourceFamilyText, "\"flashback-recording-degraded\"");
        ...
        AssertContains(diagnostics.SourceFamilyText, "(flashbackRecordingRecent.SequenceGaps > 0 && !flashbackRecordingRecentForceRotateGap)");
        AssertContains(diagnostics.SourceFamilyText, "flashbackRecordingRecent.GpuFramesDropped > 0");
        AssertContains(diagnostics.SourceFamilyText, "flashbackRecordingRecentBackpressure");
        AssertContains(diagnostics.SourceFamilyText, "flashbackRecordingQueueBacklog");
        AssertContains(diagnostics.SourceFamilyText, "flashbackAudioQueueBacklog");
        AssertContains(diagnostics.SourceFamilyText, "snapshot.FlashbackVideoBackpressureLastWaitMs >= FlashbackRecordingBackpressureWarningMs");
        AssertContains(diagnostics.SourceFamilyText, "Flashback recording path degraded:");
        AssertContains(diagnostics.SourceFamilyText, "\"flashback-export-rotation-gap\"");

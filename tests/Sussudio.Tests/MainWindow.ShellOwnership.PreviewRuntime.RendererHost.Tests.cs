...
static partial class Program
{
    private static Task PreviewRendererHostController_OwnsRuntimeState()
    {
        ...
        AssertContains(previewRuntimeD3DProjectionText, "public bool GpuActive { get; init; }");
        AssertContains(previewRuntimeD3DProjectionText, "public long D3DFramesDropped { get; init; }");
        ...
        AssertContains(previewRuntimeD3DProjectionRendererStateText, "public string RendererMode { get; init; } = \"None\";");
        AssertContains(previewRuntimeD3DProjectionRendererStateText, "public PreviewSlowFrameDiagnostic[] D3DRecentSlowFrames { get; init; } = Array.Empty<PreviewSlowFrameDiagnostic>();");
        AssertContains(previewRuntimeD3DProjectionRendererStateText, "public string GpuPlaybackState { get; init; } = \"None\";");
        AssertContains(previewRuntimeD3DProjectionDisplayCadenceText, "public double[] DisplayCadenceRecentIntervalsMs { get; init; } = Array.Empty<double>();");
        AssertContains(previewRuntimeD3DProjectionRenderCpuTimingText, "public double D3DInputUploadCpuAvgMs { get; init; }");
        AssertContains(previewRuntimeD3DProjectionPipelineLatencyText, "public double EstimatedPipelineLatencyMs { get; init; }");
        AssertContains(previewRuntimeD3DProjectionFrameOwnershipText, "public long D3DLastSubmittedPreviewPresentId { get; init; }");
        AssertContains(previewRuntimeD3DProjectionFrameStatisticsText, "public long D3DFrameStatsPresentCount { get; init; }");
        AssertContains(previewRuntimeD3DProjectionFrameLatencyWaitText, "public bool D3DFrameLatencyWaitEnabled { get; init; }");
        ...
        AssertContains(previewRuntimeD3DProjectionBuilderText, "FramesArrived = frameCounters.FramesArrived,");
        AssertContains(previewRuntimeD3DProjectionBuilderText, "D3DFramesSubmitted = frameCounters.D3DFramesSubmitted,");
        ...
        AssertContains(previewRuntimeD3DProjectionBuilderText, "RendererMode = rendererState.RendererMode,");
        AssertContains(previewRuntimeD3DProjectionBuilderText, "D3DRecentSlowFrames = rendererState.RecentSlowFrames,");
        AssertContains(previewRuntimeD3DProjectionBuilderText, "GpuPlaybackState = rendererState.GpuPlaybackState,");
        ...
        AssertContains(previewRuntimeD3DProjectionBuilderText, "DisplayCadenceObservedFps = displayCadence.ObservedFps,");
        AssertContains(previewRuntimeD3DProjectionBuilderText, "DisplayCadenceRecentIntervalsMs = displayCadence.RecentIntervalsMs,");
        ...
        AssertContains(previewRuntimeD3DProjectionBuilderText, "D3DLastSubmittedSourceSequenceNumber = frameOwnership.LastSubmittedSourceSequenceNumber,");
        AssertContains(previewRuntimeD3DProjectionBuilderText, "D3DFrameStatsPresentCount = frameStatistics.PresentCount,");
        AssertContains(previewRuntimeD3DProjectionBuilderText, "D3DFrameLatencyWaitEnabled = frameLatencyWait.Enabled,");

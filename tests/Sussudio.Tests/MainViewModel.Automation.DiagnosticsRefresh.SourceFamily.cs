static partial class Program
{
    private static AutomationDiagnosticsHubSourceFamily ReadAutomationDiagnosticsHubSourceFamily()
    {
        return new AutomationDiagnosticsHubSourceFamily
        {
            ...
            SnapshotProjectionFlatteningText = string.Join(
                "\n",
                ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.cs"),
            ...
            SnapshotProjectionFlatteningRootText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.cs"),
            ...
            SnapshotProjectionFlatteningCaptureFormatRequestedText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.CaptureFormat.Requested.cs"),
            SnapshotProjectionFlatteningCaptureFormatHdrRequestText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.CaptureFormat.HdrRequest.cs"),
            SnapshotProjectionFlatteningCaptureFormatActualText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.CaptureFormat.Actual.cs"),
            SnapshotProjectionFlatteningCaptureFormatNegotiatedText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.CaptureFormat.Negotiated.cs"),
            SnapshotProjectionFlatteningCaptureFormatReaderObservationText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.CaptureFormat.ReaderObservation.cs"),
            SnapshotProjectionFlatteningCaptureFormatEncoderText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.CaptureFormat.Encoder.cs"),
            ...
            SnapshotProjectionFlatteningMjpegPreviewJitterQueueText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.MjpegPreviewJitter.Queue.cs"),
            SnapshotProjectionFlatteningMjpegPreviewJitterTimingText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.MjpegPreviewJitter.Timing.cs"),
            SnapshotProjectionFlatteningMjpegPreviewJitterAdaptiveText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.MjpegPreviewJitter.Adaptive.cs"),
            SnapshotProjectionFlatteningMjpegPreviewJitterEventsText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.MjpegPreviewJitter.Events.cs"),
            ...
            SnapshotProjectionFlatteningSourceSignalText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.Source.Signal.cs"),
            SnapshotProjectionFlatteningSourceTelemetryText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.Source.Telemetry.cs"),
            ...
            SnapshotProjectionFlatteningPreviewRuntimeFrameText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.PreviewRuntime.Frame.cs"),
            SnapshotProjectionFlatteningPreviewRuntimeCadenceText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.PreviewRuntime.Cadence.cs"),
            SnapshotProjectionFlatteningPreviewRuntimeSurfaceText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.PreviewRuntime.Surface.cs"),
            SnapshotProjectionFlatteningPreviewRuntimeStartupText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.PreviewRuntime.Startup.cs"),
            SnapshotProjectionFlatteningPreviewRuntimeGpuPlaybackText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.PreviewRuntime.GpuPlayback.cs"),
            SnapshotProjectionFlatteningPreviewRuntimeColorText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.PreviewRuntime.Color.cs"),
            ...
            SnapshotProjectionFlatteningAudioAndIngestSignalText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.AudioAndIngest.Signal.cs"),
            SnapshotProjectionFlatteningAudioAndIngestCaptureIngestText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.AudioAndIngest.CaptureIngest.cs"),
            SnapshotProjectionFlatteningAudioAndIngestSourceReaderText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.AudioAndIngest.SourceReader.cs"),
            SnapshotProjectionFlatteningAudioAndIngestWasapiCaptureText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.AudioAndIngest.WasapiCapture.cs"),
            SnapshotProjectionFlatteningAudioAndIngestWasapiPlaybackText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.AudioAndIngest.WasapiPlayback.cs"),
            ...
            SnapshotProjectionFlatteningRecordingIntegritySummaryText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.RecordingIntegrity.Summary.cs"),
            SnapshotProjectionFlatteningRecordingIntegrityVideoText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.RecordingIntegrity.Video.cs"),
            SnapshotProjectionFlatteningRecordingIntegrityBackpressureText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.RecordingIntegrity.Backpressure.cs"),
            SnapshotProjectionFlatteningRecordingIntegrityAudioText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.RecordingIntegrity.Audio.cs"),
            SnapshotProjectionFlatteningRecordingIntegrityAvSyncText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.RecordingIntegrity.AvSync.cs"),
            ...
            SnapshotProjectionFlatteningRecordingPipelineEncoderText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.RecordingPipeline.Encoder.cs"),
            SnapshotProjectionFlatteningRecordingPipelineIngestText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.RecordingPipeline.Ingest.cs"),
            SnapshotProjectionFlatteningRecordingPipelineVideoQueueText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.RecordingPipeline.VideoQueue.cs"),
            SnapshotProjectionFlatteningRecordingPipelineHardwareQueuesText = ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.SnapshotProjection.Flattening.RecordingPipeline.HardwareQueues.cs"),
    ...
    private static string ReadAutomationDiagnosticsHubHdrSource()
    {
        return string.Join(
            ...
            new[]
            {
                ReadAutomationDiagnosticsHubSourceFile("AutomationDiagnosticsHub.Hdr.cs"),
    ...
    private sealed partial class AutomationDiagnosticsHubSourceFamily
    {
        ...
        public string HdrCoreText { get; init; } = string.Empty;

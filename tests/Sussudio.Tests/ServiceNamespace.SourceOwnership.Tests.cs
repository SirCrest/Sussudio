...
static partial class Program
{
    private static void AssertServiceNamespaceSourceOwnership(string repoRoot)
    {
        ...
        AssertContains(audioDeviceDiscoveryText, "AudioInputDevices.FirstOrDefault(d => d.Id == previousAudioId)");
        AssertContains(audioDeviceDiscoveryText, "AudioInputDevices.FirstOrDefault(d => d.Id == savedAudioId)");
        AssertContains(audioDeviceDiscoveryText, "AudioInputDevices.FirstOrDefault();");
        AssertContains(audioDeviceDiscoveryText, "MicrophoneDevices.FirstOrDefault(d => d.Id == previousMicrophoneId)");
        AssertContains(audioDeviceDiscoveryText, "MicrophoneDevices.FirstOrDefault(d => d.Id == savedMicrophoneId)");
        AssertContains(audioDeviceDiscoveryText, "MicrophoneDevices.FirstOrDefault();");

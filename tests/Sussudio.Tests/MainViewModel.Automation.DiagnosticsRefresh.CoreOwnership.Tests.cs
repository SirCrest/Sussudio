static partial class Program
{
    private static void AssertDiagnosticsRefreshCoreOwnership(AutomationDiagnosticsHubSourceFamily diagnostics)
    {
        ...
        AssertContains(diagnostics.DiagnosticEvaluationFlashbackRecordingEncoderText, "private static DiagnosticEvaluation? TryBuildFlashbackEncoderFailureDiagnosticEvaluation(");
        AssertContains(diagnostics.DiagnosticEvaluationFlashbackRecordingEncoderText, "\"Flashback encoder has failed.\"");
        AssertContains(diagnostics.DiagnosticEvaluationFlashbackRecordingExportText, "private static DiagnosticEvaluation? TryBuildFlashbackExportRotationDiagnosticEvaluation(");
        AssertContains(diagnostics.DiagnosticEvaluationFlashbackRecordingExportText, "\"flashback_export\"");
        AssertContains(diagnostics.DiagnosticEvaluationFlashbackRecordingBackendText, "private static DiagnosticEvaluation? TryBuildFlashbackBackendSettingsDiagnosticEvaluation(");
        AssertContains(diagnostics.DiagnosticEvaluationFlashbackRecordingBackendText, "\"Flashback backend settings differ from requested settings.\"");
        AssertContains(diagnostics.DiagnosticEvaluationFlashbackRecordingDegradationText, "private static DiagnosticEvaluation? TryBuildFlashbackRecordingDegradationDiagnosticEvaluation(");
        AssertContains(diagnostics.DiagnosticEvaluationFlashbackRecordingDegradationText, "\"Flashback recording path is dropping or backing up.\"");
        AssertDoesNotContain(diagnostics.DiagnosticEvaluationFlashbackRecordingText, "\"Flashback encoder has failed.\"");
        AssertDoesNotContain(diagnostics.DiagnosticEvaluationFlashbackRecordingText, "\"Flashback recording path is dropping or backing up.\"");
        ...
        AssertContains(diagnostics.DiagnosticEvaluationLanesRealtimeText, "private static string BuildSourceLane(CaptureHealthSnapshot health)");
        AssertContains(diagnostics.DiagnosticEvaluationLanesRealtimeText, "private static string BuildDecodeLane(");
        AssertContains(diagnostics.DiagnosticEvaluationLanesRealtimeText, "private static string BuildSourceSignalLane(");
        AssertContains(diagnostics.DiagnosticEvaluationLanesRealtimeText, "private static string BuildPreviewLane(");
        AssertContains(diagnostics.DiagnosticEvaluationLanesRealtimeText, "private static DiagnosticEvaluationRenderLane BuildRenderLane(");
        AssertContains(diagnostics.DiagnosticEvaluationLanesRealtimeText, "private static string BuildPresentLane(");
        AssertContains(diagnostics.DiagnosticEvaluationLanesRealtimeText, "private static string BuildVisualLane(CaptureHealthSnapshot health)");
        AssertContains(diagnostics.DiagnosticEvaluationLanesRealtimeText, "private static string BuildRecordingLane(CaptureRuntimeSnapshot captureRuntime)");
        AssertContains(diagnostics.DiagnosticEvaluationLanesRealtimeText, "private static string BuildAudioLane(CaptureRuntimeSnapshot captureRuntime)");
        ...
        AssertDoesNotContain(diagnostics.DiagnosticEvaluationLanesRealtimeText, "private static string BuildFlashbackRecordingLane(CaptureHealthSnapshot health)");

...
/// <summary>
/// Owns Flashback export diagnostics/result state independently of CaptureService.
/// CaptureService remains the transition coordinator and calls through this
/// instance directly, exactly as it already does for FlashbackBackendResources.
/// </summary>
internal sealed class FlashbackExportState
{
    ...
    public string OutputPath => _flashbackExportOutputPath;
    ...
    public static long GetFileLengthOrZero(string? path)
    {

...
// Single-file packet read loop: read frames from the active input, discover
// timestamp bases, buffer early packets, and write packets rebased to the first
// active stream timestamp.

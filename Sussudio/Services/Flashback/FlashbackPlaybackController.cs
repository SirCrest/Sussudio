...
internal sealed partial class FlashbackPlaybackController : IDisposable
{
    ...
    // See: FlashbackPlaybackController.PlaybackState.cs, .CommandQueue.cs, .CommandCoalescing.cs, .CommandTelemetry.cs, .DecoderFiles.cs,
    ...
    // .AudioMasterPacing.cs, .AudioMasterFallbacks.cs, .AudioCallback.cs, .AudioRouting.cs, .AudioPreviewGuards.cs, .AudioPrebuffer.cs, .MetricsCollection.cs
}

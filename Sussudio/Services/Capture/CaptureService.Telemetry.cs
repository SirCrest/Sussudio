...
// Source telemetry and observed pixel-format accounting. These diagnostics are
// read-only from the capture pipeline's point of view, so they live outside the

...
internal static class AutomationSnapshotFlashbackProjectionBuilder
{
    internal static FlashbackExportProjection BuildFlashbackExportProjection(CaptureHealthSnapshot health)
        => new()
        {
    ...
    internal static FlashbackExportLastResultProjection BuildFlashbackExportLastResultProjection(CaptureHealthSnapshot health)
        => new()
        {
    ...
    internal readonly record struct FlashbackExportProjection
    {
    ...
    internal readonly record struct FlashbackExportLastResultProjection
    {
    ...
    internal static FlashbackExportFlattenedProjection BuildFlashbackExportFlattenedProjection(
    ...
    internal readonly record struct FlashbackExportFlattenedProjection
    {
        public bool Active { get; init; }
        public long Id { get; init; }
        public string Status { get; init; }
    ...
    internal static FlashbackRecordingProjection BuildFlashbackRecordingProjection(
    ...
    internal readonly record struct FlashbackRecordingProjection
    {
    ...
    internal readonly record struct FlashbackRecordingStartupCacheProjection
    {
    ...
    internal readonly record struct FlashbackRecordingStartupCacheFlattenedProjection
    {
        public long TempDriveFreeBytes { get; init; }
        public long BudgetBytes { get; init; }
        public long Bytes { get; init; }
    ...
    internal readonly record struct FlashbackRecordingQueuesProjection
    {
    ...
    internal readonly record struct FlashbackRecordingQueuesFlattenedProjection
    {
        public int VideoQueueCapacity { get; init; }
        public int VideoQueueMaxDepth { get; init; }
        public long VideoFramesSubmittedToEncoder { get; init; }
    ...
    internal readonly record struct FlashbackRecordingRuntimeProjection
    {
        public bool Active { get; init; }
    ...
    internal readonly record struct FlashbackRecordingRuntimeFlattenedProjection
    {
        public bool Active { get; init; }
        public long BufferedDurationMs { get; init; }
        public long DiskBytes { get; init; }
    ...
    internal readonly record struct FlashbackRecordingBackendProjection
    {
    ...
    internal readonly record struct FlashbackRecordingBackendFlattenedProjection
    {
        public bool SettingsStale { get; init; }
        public string SettingsStaleReason { get; init; }
        public string ActiveFormat { get; init; }
    ...
    internal readonly record struct FlashbackRecordingEncoderProjection
    {
    ...
    internal readonly record struct FlashbackRecordingEncoderFlattenedProjection
    {
        public string? CodecName { get; init; }
        public uint TargetBitRate { get; init; }
        public int Width { get; init; }
    ...
    internal static FlashbackRecordingFlattenedProjection BuildFlashbackRecordingFlattenedProjection(
    ...
    internal readonly record struct FlashbackRecordingFlattenedProjection
    {
        public bool EncodingFailed { get; init; }
        public string? EncodingFailureType { get; init; }
        public string? EncodingFailureMessage { get; init; }
    ...
    internal static FlashbackPlaybackProjection BuildFlashbackPlaybackProjection(CaptureHealthSnapshot health)
    {
    ...
    internal readonly record struct FlashbackPlaybackProjection
    {
    ...
    internal readonly record struct FlashbackPlaybackAudioMasterProjection
    {
    ...
    internal readonly record struct FlashbackPlaybackAudioMasterFlattenedProjection
    {
        public long DelayDoubles { get; init; }
        public long DelayShrinks { get; init; }
        public long Fallbacks { get; init; }
    ...
    internal readonly record struct FlashbackPlaybackTimingProjection
    {
    ...
    internal readonly record struct FlashbackPlaybackTimingFlattenedProjection
    {
        public long SegmentSwitches { get; init; }
        public long Fmp4Reopens { get; init; }
        public long WriteHeadWaits { get; init; }
    ...
    internal readonly record struct FlashbackPlaybackDecodeProjection
    {
    ...
    internal readonly record struct FlashbackPlaybackDecodeFlattenedProjection
    {
        public long SeekForwardDecodeCapHits { get; init; }
        public bool LastSeekHitForwardDecodeCap { get; init; }
        public int SampleCount { get; init; }
    ...
    internal readonly record struct FlashbackPlaybackCommandProjection
    {
    ...
    internal readonly record struct FlashbackPlaybackCommandFlattenedProjection
    {
        public bool ThreadAlive { get; init; }
        public long Enqueued { get; init; }
        public long Processed { get; init; }
    ...
    internal static FlashbackPlaybackFlattenedProjection BuildFlashbackPlaybackFlattenedProjection(
    ...
    internal readonly record struct FlashbackPlaybackFlattenedProjection
    {
        public string State { get; init; }
        public long PositionMs { get; init; }
        public string DecoderHwAccel { get; init; }

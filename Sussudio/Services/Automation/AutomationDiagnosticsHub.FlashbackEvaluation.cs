...
// Flashback diagnostic verdicts, lifted out of AutomationDiagnosticsHub.Evaluation.cs into a
// named owner. Nested so it still reads the hub's private diagnostic thresholds, which are
// shared with the alert snapshot path and pinned to the hub root by contract tests.
public sealed partial class AutomationDiagnosticsHub
{
    internal static class FlashbackDiagnosticEvaluator
    {
        internal static DiagnosticEvaluation? TryBuildFlashbackDiagnosticEvaluation(

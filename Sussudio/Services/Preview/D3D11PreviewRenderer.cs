...
internal sealed partial class D3D11PreviewRenderer : IPreviewFrameSink, IPreviewFrameQueueControl, IPreviewDisplayClock, IDisposable
{
    ...
    // Wait before upload/render, keeping Present(1) from consuming a full frame
    // interval after that work at 4K120. Keep the compositor queue shallow and
    // retain overrides for measurements on other machines or display modes.
    ...
    private readonly bool _waitableSwapChainEnabled = EnvironmentHelpers.GetIntFromEnv("SUSSUDIO_PREVIEW_WAITABLE_SWAPCHAIN", 1, 0, 1) != 0;

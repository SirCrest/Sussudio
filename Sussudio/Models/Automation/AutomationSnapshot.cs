...
public sealed class AutomationSnapshot
{
    ...
    // Capture settings and negotiated format.
    ...
    // Audio, ingest, process, thread, and A/V sync evidence.
    ...
    // Recording and encoder pipeline evidence.
    ...
    // Preview, D3D, and display cadence evidence.
    ...
    // Capture cadence, MJPEG, packet hash, and visual cadence evidence.
    ...
    // Flashback recording, playback, and export evidence.

...
public partial class MainViewModel : ObservableObject, IDisposable, IAsyncDisposable, IAutomationViewModel
{
    ...
    // Recording format automation: MainViewModel.AutomationRecordingFormat.cs; split encode mode: MainViewModel.AutomationSplitEncodeMode.cs; custom bitrate: MainViewModel.AutomationCustomBitrate.cs; encoder settings: MainViewModel.AutomationRecordingSettings.cs; output path: MainViewModel.AutomationOutputPath.cs

...
public static class FlashbackTools
{
    ...
    [McpServerTool, Description("Export flashback buffer to an MP4 file. Exports the most recent N seconds of the rolling buffer. Refuses to overwrite an existing destination file; choose a path that does not exist.")]

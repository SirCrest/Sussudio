...
public static class DiagnosticSessionTools
{
    ...
    public static async Task<string> run_diagnostic_session(
        ...
        [Description("Session scenario: observe, preview-only, recording-only, flashback, flashback-stress, flashback-scrub-stress, flashback-restart-cycle, flashback-export-playback, flashback-lifecycle, flashback-export-concurrent, flashback-disable-during-export, flashback-preview-cycle, flashback-recording, flashback-recording-preview-cycle, flashback-recording-export-rejected, flashback-export-rejected, or combined.")] string scenario = "observe",

...
// Formats CLI command results. Snapshot sections are rendered by AutomationSnapshotFormatter;
// command execution and pipe communication remain outside the formatting code.
internal static class Formatters
{
    ...
    public static string FormatSnapshot(JsonElement snapshotResponse)
        => AutomationSnapshotFormatter.FormatCliSnapshot(snapshotResponse);
}

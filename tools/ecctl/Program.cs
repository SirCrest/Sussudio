...
internal static class Program
{
    ...
    private static void WriteHelp()
    {
        ...
        Console.WriteLine("  diagnostic-session [--scenario observe|preview-only|recording-only|flashback|combined] [--seconds N] [--sample-ms N] [--output PATH] [--presentmon] [--presentmon-path PATH] [--verify] [--leave-running] [--json]");
        Console.WriteLine();

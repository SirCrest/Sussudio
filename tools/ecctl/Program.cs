...
internal static class Program
{
    ...
    private static void WriteHelp()
    {
        ...
        Console.WriteLine("  diagnostic-session [--scenario observe|preview-only|recording-only|flashback|flashback-stress|flashback-scrub-stress|flashback-restart-cycle|flashback-export-playback|flashback-lifecycle|flashback-export-concurrent|flashback-disable-during-export|flashback-preview-cycle|flashback-recording|flashback-recording-preview-cycle|flashback-export-rejected|combined] [--seconds N] [--sample-ms N] [--output PATH] [--presentmon] [--presentmon-path PATH] [--verify] [--leave-running] [--json]");
        Console.WriteLine();

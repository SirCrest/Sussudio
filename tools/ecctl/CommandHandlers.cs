...
internal static class CommandHandlers
{
    ...
    private static async Task<int> HandleDiagnosticSessionAsync(CommandContext context)
    {
        ...
        EnsureNoArgs(context.Rest, "diagnostic-session [--scenario observe|preview-only|recording-only|flashback|flashback-stress|flashback-scrub-stress|flashback-restart-cycle|flashback-encoder-cycle|flashback-export-playback|flashback-segment-playback|flashback-range-export|flashback-lifecycle|flashback-export-concurrent|flashback-disable-during-export|flashback-preview-cycle|flashback-recording|flashback-recording-preview-cycle|flashback-recording-settings-deferred|flashback-recording-export-rejected|flashback-export-rejected|combined] [--seconds N] [--sample-ms N] [--output PATH] [--presentmon] [--presentmon-path PATH] [--verify] [--leave-running] [--json]");

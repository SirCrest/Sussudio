...
internal static class CommandHandlers
{
    ...
    private static async Task<int> HandleDiagnosticSessionAsync(CommandContext context)
    {
        ...
        EnsureNoArgs(context.Rest, "diagnostic-session [--scenario observe|preview-only|recording-only|flashback|flashback-stress|combined] [--seconds N] [--sample-ms N] [--output PATH] [--presentmon] [--presentmon-path PATH] [--verify] [--leave-running] [--json]");

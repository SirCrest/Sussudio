...
public sealed class AutomationDiagnosticsHub : IAutomationDiagnosticsHub
{
    ...
    private async Task RefreshSnapshotAsync(CancellationToken cancellationToken)
    {
        ...
        var snapshot = new AutomationSnapshot
        {
            ...
            PreviewSourceReaderAdapterFramesEnqueued = previewRuntime.SourceReaderAdapterFramesEnqueued,
            PreviewSourceReaderAdapterSamplesDelivered = previewRuntime.SourceReaderAdapterSamplesDelivered,
            PreviewSourceReaderAdapterSamplesTimedOut = previewRuntime.SourceReaderAdapterSamplesTimedOut,
            PreviewCadenceSampleCount = previewRuntime.DisplayCadenceSampleCount,

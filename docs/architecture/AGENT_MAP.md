...
- `FlashbackPlaybackController.ThreadCommands.cs` owns playback-thread pause,
  go-live, stop, and nudge command execution, including thread-local playback
  state, exact resume targets, live-restore handoff, and audio/preview

...
| Audio capture | `Sussudio/Services/Audio/WasapiAudioCapture.cs`, `WasapiAudioCapture.Conversion.cs` | WASAPI device lifecycle/capture thread/hot writer fan-out and f32le 48 kHz stereo conversion/resampling helpers |

...
| Flashback | `FlashbackPlaybackController.cs`, `FlashbackPlaybackController.Markers.cs`, `FlashbackPlaybackController.PositionMapping.cs`, `FlashbackPlaybackController.Metrics.cs`, `FlashbackEncoderSink.cs`, `FlashbackEncoderSink.ForceRotate.cs`, `FlashbackEncoderSink.Options.cs`, `FlashbackEncoderSink.Queues.cs`, `FlashbackExporter.cs`, `FlashbackExporter.Infrastructure.cs` | playback core, marker owner, position/file-PTS mapping, metrics, buffer, encoder runtime, export force-rotation handshake, encoder options/packet helpers, encoder queue helpers, export modules, export infrastructure |

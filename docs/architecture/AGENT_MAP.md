...
- `FlashbackExporter.Validation.cs` owns completed-output length probing, final
  ...
  export-range validation, and segment/export-range overlap classification.

...
- `tests/Sussudio.Tests/CaptureService.HealthSnapshots.Tests.cs` owns
  ...
  MJPEG, Flashback buffer/backend, Flashback export, Flashback playback, and
  recording.

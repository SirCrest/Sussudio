...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.Resources.cs` owns D3D
  ...
  Family-specific teardown stays next to creation: VideoProcessor input texture

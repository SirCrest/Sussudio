...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.Counters.RealtimePreview.cs`
  owns preview jitter, MJPEG, and D3D recent-counter baselines and delta
  updates.

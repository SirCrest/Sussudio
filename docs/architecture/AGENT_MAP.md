...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.RenderPasses.cs` owns
  ...
  precedence, timing bucket attribution, viewport and letterbox helpers,
  present accounting, and HDR fallback logging there.

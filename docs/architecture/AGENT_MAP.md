...
| Recording | `Sussudio/Services/Recording/LibAvEncoder.cs`, `LibAvEncoder.CodecPolicy.cs`, `LibAvRecordingSink.cs` | encoder runtime, codec/options policy, sink lifecycle, verifier/finalizer |

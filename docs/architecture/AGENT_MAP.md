...
- `FlashbackEncoderSink.cs` owns construction, root field state, public runtime counters, queue telemetry, encoder status/format projections, saturated PTS conversion, non-negative byte/duration math, and best-effort eviction resume fallback.

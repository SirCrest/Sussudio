...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.FlashbackRecordingAlerts.cs`
  ...
  progress/force-rotation gap alerts, temp-cache pressure alerts, encoder
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.Alerts.cs` owns
  Flashback playback performance orchestration, submit-failure alerts,
  audio-master fallback alerts, and audio-queue backlog alerts.
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.Verification.cs` owns
  ...
  verification profile shaping, and event publication for explicit
  verification.
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.PreviewD3D.cs`
  ...
  deltas consumed by `AutomationSnapshot`.
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.Verification.cs` owns
  ...
  and explicit verification events.
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.Verification.Auto.cs`

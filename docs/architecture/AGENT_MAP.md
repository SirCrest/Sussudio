...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.Audio.cs`
  ...
  groups, final audio/ingest projection-to-`AutomationSnapshot` flattening,
  audio drop counter projection, derived real-time/file-writer drop totals, and

...
- `FlashbackPlaybackController.SeekDisplay.cs` owns seek/scrub keyframe display,
  ...
  submission/held-frame release, and no-frame seek-display failure accounting.

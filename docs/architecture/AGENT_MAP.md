...
| Preview rendering | `D3D11PreviewRenderer.cs`, `D3D11PreviewRenderer.Rendering.cs`, `D3D11PreviewRenderer.Metrics.cs`, `D3D11PreviewRenderer.ScreenshotCapture.cs`, `D3D11PreviewRenderer.ShaderSources.cs` | renderer host, render loop, present/latency metrics, screenshot capture, shader source, timing models |

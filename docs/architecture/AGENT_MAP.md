...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.Hdr.cs` owns HDR
  pixel-format helpers used by automation snapshots.
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.Hdr.Preview.cs` owns
  preview HDR input detection and tone-map state projection.

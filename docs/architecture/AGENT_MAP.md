...
- `FlashbackPlaybackController.PlaybackPtsCadence.cs` owns decoded PTS cadence
  state, tracking, mismatch telemetry, and cadence-baseline reset.
...
- `FlashbackPlaybackController.Metrics.cs` owns playback diagnostic counters
  ...
  projection and seek-cap telemetry projection.

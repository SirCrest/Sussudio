...
- `FlashbackPlaybackController.ThreadCommands.cs` owns playback-thread command
  execution for seek, scrub begin/update/end, play, pause, go-live, and nudge,
  including thread-local playback state, exact resume targets, and
  audio/preview suppression/resume ordering.

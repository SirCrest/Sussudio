...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.Resources.cs` owns D3D
  ...
  teardown. Family-specific teardown stays next to creation: input/HDR texture
  cleanup in `D3D11PreviewRenderer.InputResources.cs`, shader/SRV cleanup in

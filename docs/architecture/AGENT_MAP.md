...
- `FlashbackEncoderSink.Startup.cs` owns buffer session creation, generated session ID formatting, encoder initialization, active-segment setup, PTS continuation, background task startup, and start-transaction orchestration.

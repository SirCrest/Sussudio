...
- `FlashbackPlaybackController.Metrics.cs` owns playback diagnostic counters
  ...
  projection, decoded-PTS cadence projection, and seek-cap telemetry
  projection.
...
- `FlashbackPlaybackController.PlaybackDecodeMetricsCollection.cs` owns
  ...
  wrappers, and dominant decode phase resolution.

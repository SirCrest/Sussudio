...
- `FlashbackEncoderSink.ForceRotateRequests.cs` owns export force-rotate request admission, the `ForceRotateRequest` state machine, timeout/cancellation classification, pending-request cleanup, and force-rotate drain abort policy.

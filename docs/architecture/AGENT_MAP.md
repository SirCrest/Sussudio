...
| Source telemetry | `Sussudio/Services/Telemetry/NativeXuAtCommandProvider.cs`, `NativeXuAtCommandProvider.DiagnosticSummary.cs`, `NativeXuAtCommandProvider.TelemetryDetails.cs` | Native XU transport/polling, diagnostic summary formatting, source telemetry detail presentation |

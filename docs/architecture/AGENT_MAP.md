...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.Composition.cs`
  ...
  diagnostic classifiers, projection-to-flattened-set dispatch, invocation of
  every focused final-domain flattener, and the private flattened
  projection-set handoff.

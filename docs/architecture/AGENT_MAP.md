...
|------|---------------------|----------------------|
| Diagnostic sessions | `tools/Common/DiagnosticSessionRunner.cs`, `tools/Common/DiagnosticSessionRunExecution.cs`, `tools/Common/DiagnosticSessionRunContext.cs`, `tools/Common/DiagnosticSessionRunContext.InitialSnapshot.cs`, `tools/Common/DiagnosticSessionRunContext.LiveState.cs`, `tools/Common/DiagnosticSessionRunContext.Lifetime.cs`, `tools/Common/DiagnosticSessionRunContext.PhaseContexts.cs`, `tools/Common/DiagnosticSessionRunExecution.Completion.cs`, `tools/Common/DiagnosticSessionRunExecution.CompletionContext.cs`, `tools/Common/DiagnosticSessionRunExecution.ResultBuildRequest.cs`, `tools/Common/DiagnosticSessionScenarioPhaseRunner.cs`, `tools/Common/DiagnosticSessionScenarioPhaseContext.cs`, `tools/Common/DiagnosticSessionScenarioPhaseResult.cs`, `tools/Common/DiagnosticSessionScenarioPhaseState.cs`, `tools/Common/DiagnosticSessionScenarioPhaseRunner.Sampling.cs`, `tools/Common/DiagnosticSessionScenarioPhaseCompletion.cs` | public runner compatibility wrapper, phase sequencing, core mutable run infrastructure, initial snapshot state, live-state handoff, run context disposal, scenario/completion context construction, post-cleanup completion phase, completion context handoff, result-build request mapping, named scenario phase execution/context/result/state, scenario sampling, post-sampling completion order/fault-drain delegation, run bootstrap/options normalization, scenario catalog, startup/cleanup/recording-check/post-run snapshot helpers, result formatter, plus per-scenario runners |
...
| Capture runtime | `Sussudio/Services/Capture/CaptureService.cs`, `CaptureService.Initialization.cs`, `CaptureService.Audio.cs`, `CaptureService.AudioPreviewLifecycle.cs`, `CaptureService.AudioInputSwitching.cs`, `CaptureService.MicrophoneMonitor.cs`, `CaptureService.MicrophoneMonitor.Update.cs`, `CaptureService.MicrophoneMonitor.Disposal.cs`, `CaptureService.MicrophoneMonitor.Restart.cs`, `PreviewAudioGraphResources.cs`, `CaptureRecordingBackendResources.cs`, `CaptureVideoPipelineResources.cs`, `CaptureService.Cleanup.cs`, `CaptureService.Coordination.cs`, `CaptureService.TransitionExecution.cs`, `CaptureService.DisposalLifecycle.cs`, `CaptureService.ResourceRelease.cs`, `CaptureService.DeferredCleanup.cs`, `CaptureService.Failures.cs`, `CaptureService.FailureCleanup.cs`, `CaptureService.FlashbackBackendFailureCleanup.cs`, `CaptureService.FlashbackState.cs`, `CaptureService.FlashbackEnable.cs`, `CaptureService.FlashbackRestart.cs`, `CaptureService.FlashbackBufferSettings.cs`, `CaptureService.FlashbackRecordingFormat.cs`, `CaptureService.FlashbackEncoderSettings.cs`, `CaptureService.FlashbackAudioInputs.cs`, `CaptureService.FlashbackPreviewBackend.cs`, `CaptureService.FlashbackPreviewBackendDisposal.cs`, `CaptureService.FlashbackBufferCycle.cs`, `CaptureService.FlashbackExportDiagnostics.cs`, `CaptureService.FlashbackExportProgress.cs`, `CaptureService.FlashbackExportFailureClassification.cs`, `CaptureService.FlashbackExportOperations.cs`, `CaptureService.FlashbackExportBackendSnapshot.cs`, `CaptureService.FlashbackExportRangeResolution.cs`, `CaptureService.FlashbackExportCore.cs`, `CaptureService.FlashbackExportForceRotate.cs`, `CaptureService.FlashbackExportRequestPreparation.cs`, `CaptureService.FlashbackExportPlanning.cs`, `CaptureService.FlashbackRecording.cs`, `CaptureService.FlashbackRecording.SessionContext.cs`, `CaptureService.FlashbackRecording.FrameRate.cs`, `CaptureService.FlashbackRecording.SnapshotCompatibility.cs`, `CaptureService.HealthSnapshots.cs`, `CaptureService.HealthSnapshotCaptureCadence.cs`, `CaptureService.HealthSnapshotMjpeg.cs`, `CaptureService.HealthSnapshotAssembler.cs`, `CaptureService.HealthSnapshotFlashbackBackend.cs`, `CaptureService.HealthSnapshotFlashbackBackend.Queues.cs`, `CaptureService.HealthSnapshotSourceTelemetry.cs`, `CaptureService.HealthSnapshotFlashbackExport.cs`, `CaptureService.HealthSnapshotFlashbackPlayback.cs`, `CaptureService.HealthSnapshotFlashbackPlayback.State.cs`, `CaptureService.HealthSnapshotFlashbackPlayback.Cadence.cs`, `CaptureService.HealthSnapshotFlashbackPlayback.Decode.cs`, `CaptureService.HealthSnapshotFlashbackPlayback.AudioMaster.cs`, `CaptureService.HealthSnapshotFlashbackPlayback.Commands.cs`, `CaptureService.HealthSnapshotRecording.cs`, `CaptureService.HealthSnapshotRecordingActiveBackend.cs`, `CaptureService.PreviewStart.cs`, `CaptureService.PreviewStart.Recycle.cs`, `CaptureService.PreviewStart.FastPath.cs`, `CaptureService.PreviewStart.FreshPipeline.cs`, `CaptureService.PreviewAudioGraph.cs`, `CaptureService.PreviewStop.cs`, `CaptureService.PreviewReuse.cs`, `CaptureService.PreviewDisposal.cs`, `CaptureService.VideoPipelineLifecycle.cs`, `CaptureService.Probes.cs`, `CaptureService.RecordingIntegrity.cs`, `CaptureService.RecordingIntegrity.Summary.cs`, `CaptureService.RecordingIntegrity.SummaryFields.cs`, `CaptureService.RecordingIntegrity.SummaryEvaluation.cs`, `CaptureService.RecordingIntegrity.Counters.cs`, `CaptureService.RecordingIntegrity.Audio.cs`, `CaptureService.RecordingLifecycle.cs`, `CaptureService.RecordingStartContext.cs`, `CaptureService.RecordingStartFlashback.cs`, `CaptureService.RecordingStartLibAv.cs`, `CaptureService.RecordingStartLibAv.VideoCapture.cs`, `CaptureService.RecordingStartLibAv.AudioInputs.cs`, `CaptureService.RecordingStopLifecycle.cs`, `CaptureService.RecordingFinalizeFlashbackBackend.cs`, `CaptureService.RecordingFinalizeLibAvBackend.cs`, `CaptureService.RecordingFinalizeLibAvVideoBoundary.cs`, `CaptureService.RecordingFinalizeLibAvSink.cs`, `CaptureService.RecordingFinalizeLibAvIdlePreview.cs`, `CaptureService.RecordingFinalizeLibAvPreviewRestore.cs`, `CaptureService.RecordingFinalizeFlashback.cs`, `CaptureService.RecordingOutcomeState.cs`, `CaptureService.RecordingRollback.cs`, `CaptureService.RuntimeSnapshots.cs`, `CaptureService.RuntimeSnapshotAssembler.cs`, `CaptureService.RuntimeSnapshotIngestAudio.cs`, `CaptureService.RuntimeSnapshotReaderTransport.cs`, `CaptureService.RuntimeSnapshotHdrPipeline.cs`, `CaptureService.RuntimeSnapshotSourceTelemetry.cs`, `CaptureService.RuntimeSnapshotRecordingIntegrity.cs`, `CaptureService.Snapshots.cs`, `CaptureService.SnapshotRecordingStats.cs`, `CaptureService.SnapshotRecordingFormat.cs`, `CaptureService.SnapshotObservedFrames.cs`, `CaptureService.SnapshotAvSync.cs`, `CaptureService.SnapshotTelemetry.cs`, `CaptureService.ObservedPixelTelemetry.cs`, `CaptureService.Telemetry.cs`, `CaptureService.CaptureFormatTelemetry.cs` | service state and construction owner, initialization owner, preview volume/audio event owner, audio-preview lifecycle owner, live audio input switching owner, microphone monitor state/event owner, microphone monitor update transaction owner, microphone capture disposal owner, post-recording microphone monitor restart owner, preview audio resource owner, active recording backend resource owner, video pipeline resource owner, cleanup owner, transition coordination/state-sampling owner, transition transaction owner, disposal-triggered cleanup caller, resource release helper owner, deferred cleanup owner, failure callback and failure-telemetry owner, fatal cleanup launch owner, Flashback backend failure cleanup/device-lost owner, Flashback public state owner, Flashback enable/disable transition owner, Flashback restart orchestration owner, Flashback buffer/GPU setting owner, Flashback recording-format change owner, Flashback encoder-setting cycle owner, Flashback audio input restoration owner, Flashback preview backend startup owner, Flashback preview backend disposal owner, Flashback buffer cycle coordination owner, Flashback export diagnostics lifecycle owner, Flashback export progress/fallback telemetry owner, Flashback export failure taxonomy, Flashback export entry/routing owner, Flashback export backend snapshot/lock handoff owner, Flashback export range-resolution owner, Flashback export core lifetime owner, Flashback export force-rotate preparation owner, Flashback export request assembly owner, Flashback export segment-planning/throttle owner, Flashback recording backend/capability owner, Flashback recording session-context assembly owner, Flashback recording frame-rate rational policy owner, Flashback recording snapshot compatibility owner, health snapshot sampler with capture cadence/MJPEG projections, health snapshot DTO assembler and handoff owner, Flashback backend health projection, Flashback queue health projection, source telemetry health projection, Flashback export health projection, Flashback playback health projection, recording health orchestration, active recording backend health projection, preview start transition owner, preview audio graph owner, preview disposal transition owner, video pipeline lifecycle owner, probe owner, recording integrity active-backend resolver, integrity summary DTO/log owner, normalized integrity summary input owner, integrity status/reason evaluation owner, integrity counter DTO/capture, audio integrity DTO/capture, recording start transition/router and rollback-state holder, recording start context request owner, Flashback recording start owner, LibAv recording start sequence owner, LibAv recording video-capture startup owner, LibAv recording audio-input startup owner, recording stop transition/finalization router owner, Flashback recording backend finalization and reconciliation owner, LibAv recording finalization sequence and outcome publication owner, LibAv recording video-boundary stop owner, LibAv recording sink stop/dispose owner, LibAv idle-preview disposal owner, LibAv recording preview-restore owner, Flashback recording export-finalize and boundary snapshot owner, recording outcome-state owner, transient recording rollback owner, runtime snapshot sampler, runtime snapshot DTO assembler, runtime ingest/audio projection, runtime reader/transport projection, runtime HDR/encoder pipeline projection, runtime source-telemetry projection, runtime recording-integrity projection, diagnostics compatibility and shared snapshot utilities, recording stats snapshot policy, recording format snapshot policy, observed frame snapshot telemetry, A/V sync snapshot policy, source telemetry snapshot policy, observed pixel telemetry owner, source telemetry polling owner, capture-format telemetry owner, resource managers |
...
| Automation diagnostics | `Sussudio/Services/Automation/AutomationDiagnosticsHub.cs`, `AutomationDiagnosticsHub.Alerts.cs`, `AutomationDiagnosticsHub.SignalAlerts.Preview.cs`, `AutomationDiagnosticsHub.SignalAlerts.Capture.cs`, `AutomationDiagnosticsHub.SignalAlerts.AudioRecording.cs`, `AutomationDiagnosticsHub.FlashbackRecordingAlerts.cs`, `AutomationDiagnosticsHub.FlashbackRecordingAlerts.Degradation.cs`, `AutomationDiagnosticsHub.FlashbackPlaybackAlerts.Commands.cs`, `AutomationDiagnosticsHub.FlashbackPlaybackPerformanceAlerts.cs`, `AutomationDiagnosticsHub.FlashbackPlaybackPerformanceAlerts.Audio.cs`, `AutomationDiagnosticsHub.FlashbackPlaybackPerformanceAlerts.Cadence.cs`, `AutomationDiagnosticsHub.DiagnosticEvents.cs`, `AutomationDiagnosticsHub.DiagnosticEvaluation.cs`, `AutomationDiagnosticsHub.DiagnosticEvaluationFlashback.cs`, `AutomationDiagnosticsHub.DiagnosticEvaluationRealtime.cs`, `AutomationDiagnosticsHub.DiagnosticEvaluationRealtime.Preview.cs`, `AutomationDiagnosticsHub.DiagnosticEvaluationLanes.cs`, `AutomationDiagnosticsHub.DiagnosticEvaluationLanes.Realtime.Source.cs`, `AutomationDiagnosticsHub.DiagnosticEvaluationLanes.Realtime.Preview.cs`, `AutomationDiagnosticsHub.EvaluationModels.cs`, `AutomationDiagnosticsHub.Evaluation.cs`, `AutomationDiagnosticsHub.EvaluationPolicy.cs`, `AutomationDiagnosticsHub.Lifecycle.cs`, `AutomationDiagnosticsHub.OutputFiles.cs`, `AutomationDiagnosticsHub.PreviewPacing.cs`, `AutomationDiagnosticsHub.ProcessMetrics.cs`, `AutomationDiagnosticsHub.Snapshots.cs`, `AutomationDiagnosticsHub.SnapshotProjection.cs`, `AutomationDiagnosticsHub.SnapshotProjection.Composition.cs`, `AutomationDiagnosticsHub.SnapshotProjection.Flattening.Set.cs`, `AutomationDiagnosticsHub.SnapshotProjection.Flattening.AutomationSnapshot.cs`, `AutomationDiagnosticsHub.SnapshotProjection.SnapshotStatus.cs`, `AutomationDiagnosticsHub.SnapshotProjection.SnapshotEvaluation.cs`, `AutomationDiagnosticsHub.SnapshotProjection.Audio.cs`, `AutomationDiagnosticsHub.SnapshotProjection.CaptureIngest.cs`, `AutomationDiagnosticsHub.SnapshotProjection.WasapiAudio.cs`, `AutomationDiagnosticsHub.SnapshotProjection.AvSync.cs`, `AutomationDiagnosticsHub.SnapshotProjection.CaptureCommands.cs`, `AutomationDiagnosticsHub.SnapshotProjection.CaptureFormat.cs`, `AutomationDiagnosticsHub.SnapshotProjection.CaptureTransport.cs`, `AutomationDiagnosticsHub.SnapshotProjection.CaptureCadence.cs`, `AutomationDiagnosticsHub.SnapshotProjection.VisualCadence.cs`, `AutomationDiagnosticsHub.SnapshotProjection.Mjpeg.cs`, `AutomationDiagnosticsHub.SnapshotProjection.MjpegTiming.cs`, `AutomationDiagnosticsHub.SnapshotProjection.MjpegPreviewJitter.cs`, `AutomationDiagnosticsHub.SnapshotProjection.MjpegPacketHash.cs`, `AutomationDiagnosticsHub.SnapshotProjection.FlashbackExport.cs`, `AutomationDiagnosticsHub.SnapshotProjection.FlashbackPlayback.cs`, `AutomationDiagnosticsHub.SnapshotProjection.FlashbackPlayback.AudioMaster.cs`, `AutomationDiagnosticsHub.SnapshotProjection.FlashbackPlayback.Decode.cs`, `AutomationDiagnosticsHub.SnapshotProjection.FlashbackPlayback.Commands.cs`, `AutomationDiagnosticsHub.SnapshotProjection.FlashbackRecording.cs`, `AutomationDiagnosticsHub.SnapshotProjection.FlashbackRecordingQueues.cs`, `AutomationDiagnosticsHub.SnapshotProjection.PreviewD3D.cs`, `AutomationDiagnosticsHub.SnapshotProjection.PreviewD3DCpuTiming.cs`, `AutomationDiagnosticsHub.SnapshotProjection.PreviewRuntime.cs`, `AutomationDiagnosticsHub.SnapshotProjection.ProcessResources.cs`, `AutomationDiagnosticsHub.SnapshotProjection.RecordingIntegrity.cs`, `AutomationDiagnosticsHub.SnapshotProjection.RecordingPipeline.cs`, `AutomationDiagnosticsHub.SnapshotProjection.RecordingOutput.cs`, `AutomationDiagnosticsHub.SnapshotProjection.SourceSignal.cs`, `AutomationDiagnosticsHub.SnapshotProjection.SourceTelemetry.cs`, `AutomationDiagnosticsHub.SnapshotProjection.UserSettings.cs`, `AutomationDiagnosticsHub.SnapshotProjection.HdrPipeline.cs`, `AutomationDiagnosticsHub.Counters.RealtimePreview.cs`, `AutomationDiagnosticsHub.Counters.Mjpeg.cs`, `AutomationDiagnosticsHub.Counters.FlashbackRecording.cs`, `AutomationDiagnosticsHub.SnapshotState.cs`, `AutomationDiagnosticsHub.Timeline.cs`, `AutomationDiagnosticsHub.TimelineProjection.cs`, `AutomationDiagnosticsHub.Verification.cs`, `AutomationDiagnosticsHub.Verification.Auto.cs`, `AutomationDiagnosticsHub.Verification.Profile.cs` | additional collectors/controllers when hub orchestration grows |
| Automation snapshot models | `Sussudio/Models/Automation/AutomationSnapshot.cs`, `AutomationSnapshot.AudioIngest.cs`, `AutomationSnapshot.CaptureCadence.cs`, `AutomationSnapshot.CaptureFormat.cs`, `AutomationSnapshot.FlashbackRecording.cs`, `AutomationSnapshot.FlashbackPlayback.cs`, `AutomationSnapshot.FlashbackExport.cs`, `AutomationSnapshot.Hdr.cs`, `AutomationSnapshot.MjpegTiming.cs`, `AutomationSnapshot.MjpegPreviewJitter.cs`, `AutomationSnapshot.MjpegPacketHash.cs`, `AutomationSnapshot.Preview.cs`, `AutomationSnapshot.Recording.cs`, `AutomationSnapshot.SourceTelemetry.cs`, `AutomationSnapshot.SystemHealth.cs`, `AutomationSnapshot.UserSettings.cs`, `AutomationSnapshot.VisualCadence.cs`, `AutomationCommandProtocol.cs`, `AutomationOptionsSnapshot.cs`, `CaptureRuntimeSnapshot*.cs`, `DiagnosticsEvents.cs`, `FlashbackSegmentInfo.cs`, `PerformanceTimelineEntry*.cs`, `PreviewRuntimeSnapshot*.cs`, `RecordingVerification.cs`, `VideoSourceProbe.cs`, `ViewModelRuntimeSnapshot.cs`, `WindowAutomation.cs` | automation evidence DTO partials by runtime/diagnostic surface, command protocol DTOs, automation options DTO, capture runtime DTO partials by runtime surface, diagnostics events, Flashback segment DTOs, performance timeline entry partials by diagnostics surface, preview runtime DTO partials by diagnostics surface, recording verification DTOs, video source probe DTOs, view-model runtime DTO, window automation DTOs |
| Capture snapshot models | `Sussudio/Models/Capture/CaptureDiagnosticsSnapshot.cs`, `CaptureDiagnosticsSnapshot.SourceTelemetry.cs`, `CaptureDiagnosticsSnapshot.CaptureCadence.cs`, `CaptureDiagnosticsSnapshot.Recording.cs`, `CaptureDiagnosticsSnapshot.Flashback.cs`, `CaptureDiagnosticsSnapshot.Mjpeg.cs`, `CaptureHealthSnapshot.cs`, `CaptureHealthSnapshot.FlashbackBackend.cs`, `CaptureHealthSnapshot.FlashbackPlayback.cs`, `CaptureHealthSnapshot.FlashbackExport.cs` | diagnostics core/format/HDR compatibility fields, source telemetry fields, capture cadence fields, recording/audio queue fields, Flashback queue fields, MJPEG and visual-cadence diagnostics fields, health source/queue/AV-sync extension fields, Flashback backend/playback/export health fields |
| Source telemetry | `Sussudio/Services/Telemetry/NativeXuAtCommandProvider.cs`, `NativeXuAtCommandProvider.InterfaceRead.cs`, `NativeXuAtCommandProvider.AtProtocol.cs`, `NativeXuAtCommandProvider.AudioCommands.cs`, `NativeXuAtCommandProvider.AnalogGain.cs`, `NativeXuAtCommandProvider.AudioSwitch.cs`, `NativeXuAtCommandProvider.Selector4.cs`, `NativeXuAtCommandProvider.DeviceCommands.cs`, `NativeXuAtCommandProvider.DeviceCommandReads.cs`, `NativeXuAtCommandProvider.DiagnosticSummary.cs`, `NativeXuAtCommandProvider.FullSnapshot.cs`, `NativeXuAtCommandProvider.PayloadDecoding.cs`, `NativeXuAtCommandProvider.RollingPoll.cs`, `NativeXuAtCommandProvider.RollingCommandGroups.cs`, `NativeXuAtCommandProvider.SnapshotAssembly.cs`, `NativeXuAtCommandProvider.SnapshotAssembly.CommandResults.cs`, `NativeXuAtCommandProvider.SnapshotAssembly.Timing.cs`, `NativeXuAtCommandProvider.TelemetryDetails.Build.cs`, `NativeXuAtCommandProvider.TelemetryDetails.AudioInput.cs`, `NativeXuAtCommandProvider.TelemetryDetails.Formatters.cs` | ReadAsync validation/gating through shared Native XU device support, selected-interface open/topology/node scan and node-read failure classification, AT-command transport/parsing, public HDMI/Analog audio route and gain command entry points, analog gain register mapping and writes, HDMI/Analog switch sequence, selector-4 I2C payload writes, generic public SET-command surface, generic public read-only AT-command surface, diagnostic summary formatting, reference full-snapshot command acquisition, source payload decoding/scalar helpers, active rolling poll cadence/cache, rolling command group dispatch and per-command cancellation helpers, source snapshot assembly from AT-command results, full/rolling AT-command handoff contract, VIC/frame-rate lookup policy, source telemetry detail row assembly, flash-audio input, analog-gain detail interpretation, and audio-origin policy, AT detail value formatting |
...
| Flashback | `FlashbackDecoder.cs`, `FlashbackDecoder.D3D11.cs`, `FlashbackDecoder.D3D11Discovery.cs`, `FlashbackDecoder.VideoOutput.cs`, `FlashbackDecoder.VideoConversion.cs`, `FlashbackDecoder.VideoSetup.cs`, `FlashbackDecoder.AudioOutput.cs`, `FlashbackDecoder.Timestamps.cs`, `FlashbackDecoder.Seeking.cs`, `FlashbackDecoder.DecodeLoop.cs`, `FlashbackDecoder.Validation.cs`, `FlashbackDecoder.Lifetime.cs`, `FlashbackDecoder.Diagnostics.cs`, `FlashbackDecoder.Guards.cs`, `FlashbackDecoder.OutputTypes.cs`, `FlashbackPlaybackController.cs`, `FlashbackPlaybackController.DecoderFiles.cs`, `FlashbackPlaybackController.DecoderCleanup.cs`, `FlashbackPlaybackController.DecoderReopen.cs`, `FlashbackPlaybackController.DecoderAdjacentSegmentSeek.cs`, `FlashbackPlaybackController.DecoderSegmentReopen.cs`, `FlashbackPlaybackController.Lifecycle.cs`, `FlashbackPlaybackController.PreviewDetachLifecycle.cs`, `FlashbackPlaybackController.CommandModels.cs`, `FlashbackPlaybackController.Commands.cs`, `FlashbackPlaybackController.CommandQueue.cs`, `FlashbackPlaybackController.CommandCoalescing.cs`, `FlashbackPlaybackController.CommandCoalescingSlots.cs`, `FlashbackPlaybackController.CommandControlYieldPolicy.cs`, `FlashbackPlaybackController.CommandTelemetry.cs`, `FlashbackPlaybackController.CommandMetrics.cs`, `FlashbackPlaybackController.CommandFailures.cs`, `FlashbackPlaybackController.ThreadScheduling.cs`, `FlashbackPlaybackController.ThreadLoop.cs`, `FlashbackPlaybackController.ThreadCommandDispatch.cs`, `FlashbackPlaybackController.ThreadExit.cs`, `FlashbackPlaybackController.ThreadSeekCommands.cs`, `FlashbackPlaybackController.ThreadSeekScrubCommands.cs`, `FlashbackPlaybackController.ThreadEndScrubCommand.cs`, `FlashbackPlaybackController.ThreadPlayCommand.cs`, `FlashbackPlaybackController.ThreadPauseCommand.cs`, `FlashbackPlaybackController.ThreadNudgeCommand.cs`, `FlashbackPlaybackController.ThreadCommands.cs`, `FlashbackPlaybackController.ThreadLifecycle.cs`, `FlashbackPlaybackController.ThreadStartLifecycle.cs`, `FlashbackPlaybackController.ThreadStopLifecycle.cs`, `FlashbackPlaybackController.ThreadChannel.cs`, `FlashbackPlaybackController.ThreadCleanup.cs`, `FlashbackPlaybackController.AudioRouting.cs`, `FlashbackPlaybackController.AudioPrebuffer.cs`, `FlashbackPlaybackController.AudioMasterClock.cs`, `FlashbackPlaybackController.AudioMasterPacing.cs`, `FlashbackPlaybackController.PreviewFrames.cs`, `FlashbackPlaybackController.PreviewFrameValidation.cs`, `FlashbackPlaybackController.SeekDisplay.cs`, `FlashbackPlaybackController.SeekDisplayFrames.cs`, `FlashbackPlaybackController.PlaybackLoop.cs`, `FlashbackPlaybackController.PlaybackSegmentEdges.cs`, `FlashbackPlaybackController.PlaybackSegmentSwitch.cs`, `FlashbackPlaybackController.PlaybackTiming.cs`, `FlashbackPlaybackController.PlaybackPtsCadence.cs`, `FlashbackPlaybackController.PlaybackSoftwareBudget.cs`, `FlashbackPlaybackController.Markers.cs`, `FlashbackPlaybackController.MarkersState.cs`, `FlashbackPlaybackController.PositionMapping.cs`, `FlashbackPlaybackController.PlaybackCadenceMetrics.cs`, `FlashbackPlaybackController.PlaybackDecodeMetrics.cs`, `FlashbackPlaybackController.MetricsCollection.cs`, `FlashbackPlaybackController.MetricReset.cs`, `FlashbackPlaybackController.SeekCapTelemetry.cs`, `FlashbackPlaybackController.PlaybackDecodeMetricsCollection.cs`, `FlashbackEncoderSink.cs`, `FlashbackEncoderSink.Startup.cs`, `FlashbackEncoderSink.StartupQueues.cs`, `FlashbackEncoderSink.StartupRollback.cs`, `FlashbackEncoderSink.StartupPolicy.cs`, `FlashbackEncoderSink.DiagnosticsReset.cs`, `FlashbackEncoderSink.RecordingAccounting.cs`, `FlashbackEncoderSink.EncodingLoop.cs`, `FlashbackEncoderSink.PacketDrain.Video.cs`, `FlashbackEncoderSink.PacketDrain.Audio.cs`, `FlashbackEncoderSink.EncodingProgress.cs`, `FlashbackEncoderSink.SegmentRotation.cs`, `FlashbackEncoderSink.ForceRotate.cs`, `FlashbackEncoderSink.ForceRotateRequests.cs`, `FlashbackEncoderSink.ForceRotateLifecycle.cs`, `FlashbackEncoderSink.ForceRotateRequest.cs`, `FlashbackEncoderSink.ForceRotateExecution.cs`, `FlashbackEncoderSink.Inputs.Video.cs`, `FlashbackEncoderSink.Inputs.Audio.cs`, `FlashbackEncoderSink.Lifetime.cs`, `FlashbackEncoderSink.Options.cs`, `FlashbackEncoderSink.SessionContext.cs`, `FlashbackEncoderSink.FileSessionHelpers.cs`, `FlashbackEncoderSink.PacketBuffers.cs`, `FlashbackEncoderSink.PacketTypes.cs`, `FlashbackEncoderSink.VideoQueueSubmission.cs`, `FlashbackEncoderSink.VideoQueueSubmission.Guards.cs`, `FlashbackEncoderSink.VideoQueueSubmission.Writers.cs`, `FlashbackEncoderSink.VideoQueueSubmission.Rejections.cs`, `FlashbackEncoderSink.Queues.cs`, `FlashbackEncoderSink.AudioQueueSubmission.cs`, `FlashbackEncoderSink.QueueCleanup.cs`, `FlashbackEncoderSink.Recording.State.cs`, `FlashbackEncoderSink.Recording.Start.cs`, `FlashbackEncoderSink.Recording.End.cs`, `FlashbackEncoderSink.RuntimeState.Counters.cs`, `FlashbackEncoderSink.RuntimeState.QueueMetrics.cs`, `FlashbackEncoderSink.RuntimeState.Status.cs`, `FlashbackBufferManager.cs`, `FlashbackBufferManager.LiveAccounting.cs`, `FlashbackBufferManager.SegmentMutation.cs`, `FlashbackBufferManager.SegmentCompletion.cs`, `FlashbackBufferManager.Lifecycle.cs`, `FlashbackBufferManager.RecoveryPreserve.cs`, `FlashbackBufferManager.SegmentQueries.cs`, `FlashbackBufferManager.SegmentPathSafety.cs`, `FlashbackBufferManager.SegmentStatus.cs`, `FlashbackBufferManager.Math.cs`, `FlashbackBufferManager.Retention.cs`, `FlashbackBufferManager.Purge.cs`, `FlashbackBufferManager.EvictionPause.cs`, `FlashbackStartupCacheCleanup.cs`, `FlashbackStartupSessionCacheBudget.cs`, `FlashbackExporter.cs`, `FlashbackExporter.SingleFile.cs`, `FlashbackExporter.SingleFilePacketWriting.cs`, `FlashbackExporter.SingleFilePacketReadLoop.cs`, `FlashbackExporter.Segments.cs`, `FlashbackExporter.SegmentPacketWriting.cs`, `FlashbackExporter.SegmentPacketReadLoop.cs`, `FlashbackExporter.SegmentPacketWriteState.cs`, `FlashbackExporter.SegmentPacketRebasing.cs`, `FlashbackExporter.SegmentRangeProjection.cs`, `FlashbackExporter.SegmentSkipTracking.cs`, `FlashbackExporter.SegmentTemplate.cs`, `FlashbackExporter.SegmentValidation.cs`, `FlashbackExporter.TempFiles.cs`, `FlashbackExporter.Requests.cs`, `FlashbackExporter.Lifetime.cs`, `FlashbackExporter.Execution.cs`, `FlashbackExporter.PacketTiming.cs`, `FlashbackExporter.PacketBuffers.cs`, `FlashbackExporter.Streams.cs`, `FlashbackExporter.StreamTemplates.cs`, `FlashbackExporter.OutputFiles.cs`, `FlashbackExporter.Progress.cs`, `FlashbackExporter.WriterPacing.cs`, `FlashbackExporter.ExportLock.cs`, `FlashbackExporter.OutputValidation.cs`, `FlashbackExporter.PathValidation.cs`, `FlashbackExporter.SegmentSelection.cs`, `FlashbackExporter.NativeState.cs`, `FlashbackExporter.Cancellation.cs`, `FlashbackExporter.LibAvErrors.cs`, `FlashbackExporter.TimeMath.cs` | decoder lifecycle/open/dispose shell, D3D11 device-context initialization and hardware decoder context setup, D3D11VA decoder discovery and hardware-config diagnostics, video frame output and hardware/software selection, software plane copy/conversion kernels, video codec setup and software output-buffer allocation, decoder audio packet delivery and bounded audio output, decoder timestamp/seek conversion helpers, decoder keyframe/exact seek control flow, decoder video frame receive and packet feed loop, decoder stream/frame validation helpers, decoder file-close native cleanup and held-frame release, decoder phase timing and FFmpeg error formatting, decoder state guards, decoded video/audio output DTOs, playback core, decoder file open/identity, decoder cleanup/close telemetry, active fMP4 reopen and seek recovery, adjacent-segment seek fallback, segment-edge fMP4 reopen and audio gate recovery, component lifecycle and dispose, preview-detach deferred reattach lifecycle, playback-thread command payload contract, public playback command facade, command queue/drop policy, seek/scrub coalesced command admission, seek/scrub coalescing slot resolution, playback-thread control-yield policy, command telemetry bookkeeping, public command/thread metric projection, command readiness/failure surface, playback-thread scheduling policy, playback thread command dequeue/wait loop, playback-thread command dispatch and completion telemetry, playback-thread exit transaction, playback-thread seek command execution, playback-thread scrub begin/update command execution, playback-thread end-scrub resume execution, playback-thread play command execution, playback-thread pause command execution, playback-thread nudge command execution, playback-thread go-live/stop command execution, playback thread state and timeout policy, playback-thread start/recovery lifecycle, playback-thread stop/join lifecycle, playback-thread command channel lifetime, playback thread cleanup, audio callback/routing/render helpers, audio prebuffer/rewind, audio-master clock/A/V drift projection, audio-master pacing/fallback projections, decoded frame preview submission, decoded frame validation/byte sizing, seek/scrub keyframe display, seek/scrub decoded-frame display handoff, live playback recovery, continuous playback loop, segment-edge routing/write-head handling, next-segment switch transaction, timing policy, decoded PTS cadence state/telemetry/projection, software-decode budget snap policy, marker command owner, marker state/file-PTS owner, position/file-PTS mapping, cadence metric summary, decode metric summary, playback metric collection/projection, playback metric reset, seek-cap telemetry/projection, decode timing metric collection/max projection, encoder core state/construction, encoder startup transaction, startup queue construction, startup failure rollback, startup validation and queue-capacity policy, diagnostics reset, recording accounting helpers, encode loop orchestration, video/GPU packet drains, audio/microphone packet drains, encoded-frame progress publication, segment rotation/failure recovery, export force-rotation status/idle projection, force-rotate request admission/result classification, force-rotate lifecycle cleanup, force-rotate request state machine, encoding-thread force-rotate execution, video producer input surface, audio/microphone writer input surface, stop/dispose lifecycle, encoder option construction, recording-to-Flashback session mapping, file/session helpers, packet buffer ownership, packet DTOs, encoder video/GPU queue admission, encoder video/GPU lifecycle/input guards, encoder video/GPU TryWrite depth accounting, encoder video/GPU rejection telemetry, shared encoder queue helpers, encoder audio/microphone queue admission and backlog eviction accounting, queued-buffer cleanup, recording state/gates, recording start/rollback, recording finalization, public runtime counters, public queue telemetry, public encoder status/format projections, buffer core state, buffer live byte/PTS accounting updates, buffer segment mutation surface, buffer segment completion/extension, buffer initialize/dispose lifecycle, buffer recovery-preserve markers, buffer segment query helpers, buffer segment path safety, buffer segment status/projection helpers, buffer math and saturated accounting helpers, buffer retention/eviction, buffer purge/delete-all, buffer eviction-pause state and recording PTS range capture, startup stale-root/session cleanup and free-space probing, startup session cache budget enforcement, shared exporter native state, single-file export shell, single-file packet result validation, single-file active input packet pump, multi-segment export lifecycle, multi-segment packet writing/remux orchestration, active segment packet pump, per-segment packet write state/outcomes, segment timestamp rebasing/native writes, segment export range/window projection, segment template setup, segment validation policy, temp-file cleanup, export request routing, exporter disposal, export execution scheduling, packet timestamp helpers, packet buffer lifetime helpers, stream/context setup, stream-template/layout compatibility, final output replacement, export progress helpers, export writer pacing/throttle helpers, export lock handling, export failure results, output validation, path validation, segment selection, native cleanup, linked cancellation, FFmpeg error formatting, export time math |
| Flashback playback command handlers | `FlashbackPlaybackController.ThreadPauseCommand.cs`, `FlashbackPlaybackController.ThreadNudgeCommand.cs`, `FlashbackPlaybackController.ThreadCommands.cs` | pause-from-live freeze/display and exact-resume target handling, nudge/frame-step recovery, and go-live/stop live-restore command exits |
| Preview rendering | `D3D11PreviewRenderer.cs`, `D3D11PreviewRenderer.Configuration.cs`, `D3D11PreviewRenderer.NativeInterop.cs`, `D3D11PreviewRenderer.Lifecycle.cs`, `D3D11PreviewRenderer.StopLifecycle.cs`, `D3D11PreviewRenderer.RenderThread.cs`, `D3D11PreviewRenderer.RenderThreadFailures.cs`, `D3D11PreviewRenderer.FirstFrameNotifications.cs`, `D3D11PreviewRenderer.SharedDevice.cs`, `D3D11PreviewRenderer.PendingFrame.cs`, `D3D11PreviewRenderer.MetricTypes.cs`, `D3D11PreviewRenderer.MetricSampleHelpers.cs`, `D3D11PreviewRenderer.FrameOwnership.cs`, `D3D11PreviewRenderer.DxgiFrameStatistics.cs`, `D3D11PreviewRenderer.DisplayClock.cs`, `D3D11PreviewRenderer.Submission.cs`, `D3D11PreviewRenderer.Nv12Submission.cs`, `D3D11PreviewRenderer.RenderPasses.cs`, `D3D11PreviewRenderer.Nv12ShaderPass.cs`, `D3D11PreviewRenderer.HdrShaderPass.cs`, `D3D11PreviewRenderer.Present.cs`, `D3D11PreviewRenderer.ShaderRendering.cs`, `D3D11PreviewRenderer.ShaderCompilation.cs`, `D3D11PreviewRenderer.ShaderBlobInterop.cs`, `D3D11PreviewRenderer.DeviceLost.cs`, `D3D11PreviewRenderer.DeviceInitialization.cs`, `D3D11PreviewRenderer.FrameUpload.cs`, `D3D11PreviewRenderer.RawFrameUpload.cs`, `D3D11PreviewRenderer.FrameLatency.cs`, `D3D11PreviewRenderer.Viewport.cs`, `D3D11PreviewRenderer.Resources.cs`, `D3D11PreviewRenderer.VideoProcessorPipeline.cs`, `D3D11PreviewRenderer.VideoProcessorOutputViews.cs`, `D3D11PreviewRenderer.VideoProcessorColorSpaces.cs`, `D3D11PreviewRenderer.InputResources.cs`, `D3D11PreviewRenderer.HdrInputResources.cs`, `D3D11PreviewRenderer.PanelBinding.cs`, `D3D11PreviewRenderer.PanelComposition.cs`, `D3D11PreviewRenderer.PendingFrames.cs`, `D3D11PreviewRenderer.PresentCadenceMetrics.cs`, `D3D11PreviewRenderer.Metrics.cs`, `D3D11PreviewRenderer.MetricWindows.cs`, `D3D11PreviewRenderer.MetricsTracking.cs`, `D3D11PreviewRenderer.SlowFrameDiagnostics.cs`, `D3D11PreviewRenderer.SlowFrameDxgiSlip.cs`, `D3D11PreviewRenderer.SlowFrameReasons.cs`, `D3D11PreviewRenderer.ScreenshotRequests.cs`, `D3D11PreviewRenderer.ScreenshotStaging.cs`, `D3D11PreviewRenderer.ScreenshotResults.cs`, `D3D11PreviewRenderer.ScreenshotCapture.cs`, `D3D11PreviewRenderer.ScreenshotPngCompletion.cs`, `PreviewScreenshotCapture.cs`, `PreviewPng16Encoder.cs`, `PreviewShaderSources.cs` | renderer public facade, construction, constants, and user-facing state accessors, env-tuned runtime configuration, native panel/shader/DWM interop, render-thread startup/disposal state, stop/unbind/native-call fence lifecycle, render-thread loop/orchestration plus shared-device reset consumption, composition-transform wake handling, pending-frame consumption, render-thread failure telemetry state, first-frame notification state, shared-device COM reference handoff, reinit retirement, reset scheduling, and initialization bridge, pending-frame lifetime model, renderer metric model types, shared metric sample helpers, submitted/rendered/dropped frame ownership state and telemetry, DXGI frame statistics state, display-clock projection, public raw/lease/single-texture frame submission entry points, dual-plane NV12 submission and HDR transition telemetry, render-pass selection plus VideoProcessor pass execution, NV12 shader pass execution, HDR shader pass execution, shared present/accounting transaction, shader state and cached shader resources, shader compilation resources, D3DCompiler blob interop, device-lost classification and recovery, D3D device/swap-chain initialization, VideoProcessor input-view resolution and external-texture input-view helpers, raw frame direct/staging upload helpers, frame-latency waitable swap-chain state/setup/waits, viewport and letterbox helpers, D3D object fields and top-level cleanup orchestration, video-processor pipeline setup/teardown, video-processor output-view/RTV reuse, VideoProcessor color-space updates, VideoProcessor input texture resources, HDR shader input texture resources, swap-chain panel native bind/unbind state, panel size/transform state, pending-frame queue/signaling state, read-only present-cadence metrics state/projection, read-only latency/render/wait metrics state/projection, expected-frame-rate metric window sizing/reset, render-loop metric window tracking, slow-frame diagnostic ring/projection, slow-frame DXGI refresh-slip capture, slow-frame reason classification, screenshot capture request lifecycle, screenshot staging reuse/teardown, screenshot result shaping/logging, screenshot capture GPU/readback flow, PNG completion gate state, preview BMP/PNG pixel analysis and file encoding, HLSL shader sources, timing models |
| Preview render-thread helpers | `D3D11PreviewRenderer.RenderThread.SharedDeviceReset.cs`, `D3D11PreviewRenderer.RenderThread.Composition.cs`, `D3D11PreviewRenderer.RenderThread.FrameDispatch.cs`, `D3D11PreviewRenderer.RenderThread.Shutdown.cs` | shared-device rebind/reset consumption, composition-transform wake handling, queued-frame render dispatch, and final render-thread drain/state reset |
...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.Lifecycle.cs` owns
  render-thread startup state, startup reset, and renderer disposal.
...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.RenderThread.cs` owns the
  render-thread loop shell: MMCSS registration, frame-ready wait, and dispatch
  ordering. `D3D11PreviewRenderer.RenderThread.SharedDeviceReset.cs` owns
  shared-device reset consumption/rebind, `D3D11PreviewRenderer.RenderThread.Composition.cs`
  owns composition-transform wake handling, `D3D11PreviewRenderer.RenderThread.FrameDispatch.cs`
  owns pending-frame consumption/render dispatch, and
  `D3D11PreviewRenderer.RenderThread.Shutdown.cs` owns final drain and renderer
  mode reset.
  `D3D11PreviewRenderer.RenderThreadFailures.cs` owns render-thread failure
  counters, latest failure fields, and UI failure notification.
  `D3D11PreviewRenderer.FirstFrameNotifications.cs` owns first-frame reset and
  first-frame UI notification.
...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.Submission.cs` owns raw,
  ...
  construction.
- `Sussudio/Services/Preview/D3D11PreviewRenderer.Nv12ShaderPass.cs` owns
  NV12 shader draw execution: native-call guard consumption, NV12 SRV binding,
  draw call, and NV12 shader-mode present message.
  `D3D11PreviewRenderer.HdrShaderPass.cs` owns HDR shader draw execution: HDR
  input upload, shader-resource binding, draw call, passthrough/tonemap mode
  selection, and HDR shader-mode present messages.
- `Sussudio/Services/Preview/D3D11PreviewRenderer.DeviceInitialization.cs`
  ...
  shader compilation handoff, and renderer-owned device fallback.
- `Sussudio/Services/Preview/D3D11PreviewRenderer.ShaderCompilation.cs` owns
  shader bytecode compilation orchestration, shader/sampler/viewport
  constant-buffer creation, and compile-fallback logging.
  `D3D11PreviewRenderer.ShaderBlobInterop.cs` owns `D3DCompileNative`
...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.Resources.cs` owns D3D
  device/swap-chain/video-processor fields plus top-level cleanup orchestration.
  `D3D11PreviewRenderer.VideoProcessorPipeline.cs` owns video-processor
  recreation orchestration and processor-resource teardown.
  `D3D11PreviewRenderer.VideoProcessorOutputViews.cs` owns output-view/RTV reuse,
  while `D3D11PreviewRenderer.VideoProcessorColorSpaces.cs` owns VideoProcessor
  input/output color-space updates. Family-specific teardown stays next to creation: VideoProcessor input texture
  cleanup in `D3D11PreviewRenderer.InputResources.cs`, HDR shader input cleanup
  in `D3D11PreviewRenderer.HdrInputResources.cs`, shader/SRV cleanup in
  `D3D11PreviewRenderer.ShaderRendering.cs`, and preview-frame capture staging
  cleanup in `D3D11PreviewRenderer.ScreenshotStaging.cs`.
- `Sussudio/Services/Preview/D3D11PreviewRenderer.PanelBinding.cs` owns native
  SwapChainPanel bind/unbind dispatch and stale-chain guards.
  `D3D11PreviewRenderer.PanelComposition.cs` owns panel size, rasterization
  scale, dirty-transform signaling, and swap-chain composition matrix updates.
- `Sussudio/Services/Preview/D3D11PreviewRenderer.PresentCadenceMetrics.cs`
  ...
  timing, and frame-latency wait metrics. `D3D11PreviewRenderer.MetricTypes.cs`
  owns renderer metric record structs, and
  `D3D11PreviewRenderer.MetricSampleHelpers.cs` owns shared ring-copy,
  timing-summary, tick-to-ms, and render-stage validation helpers.
  `D3D11PreviewRenderer.MetricWindows.cs` owns expected-frame-rate metric
  window resizing and metric reset/clear lifecycle.
- `Sussudio/Services/Preview/D3D11PreviewRenderer.DxgiFrameStatistics.cs`
  ...
  and missed-refresh accounting. `D3D11PreviewRenderer.DisplayClock.cs` owns
  visible-frame tick estimation and `IPreviewDisplayClock` snapshot projection.
- `Sussudio/Services/Preview/D3D11PreviewRenderer.SlowFrameDiagnostics.cs`
  owns recent slow-frame snapshot access, thresholding, sample assembly, and the
  slow-frame ring writer. `D3D11PreviewRenderer.SlowFrameDxgiSlip.cs` owns the
  DXGI refresh-slip snapshot used by slow-frame diagnostics.
  `D3D11PreviewRenderer.SlowFrameReasons.cs` owns slow-frame reason token
  classification.
- `Sussudio/Services/Preview/D3D11PreviewRenderer.ScreenshotRequests.cs` owns
  preview-frame capture request state, timeout/cancellation, and pending-request
  cleanup. `D3D11PreviewRenderer.ScreenshotStaging.cs` owns staging-texture
  reuse, resize, and teardown. `D3D11PreviewRenderer.ScreenshotResults.cs`
  owns error result construction and capture-result logging, while
  `D3D11PreviewRenderer.ScreenshotCapture.cs` owns render-thread request
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.Alerts.cs` owns alert
  rule evaluation, active-alert transitions, Flashback alert group routing, and
  Flashback playback alert orchestration, plus signal alert orchestration.
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.FlashbackPlaybackPerformanceAlerts.cs`
  also owns frame-submission failure alerts.
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.DiagnosticEvaluationLanes.cs`
  ...
  recording/audio lane formatting, Flashback recording/export/playback lane
  formatting, and lane DTOs used by diagnostic verdicts.
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.Flattening.Set.cs`
  owns the projection-to-flattened-set dispatch root, invocation of every
  focused final-domain flattener, and the private flattened projection-set
  handoff.
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.SnapshotStatus.cs`
  ...
  session state, status-text projection, and final snapshot status
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.CaptureIngest.cs`
  ...
  plus flattened ingest and source-reader fields consumed by
  `AutomationSnapshot`.
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.WasapiAudio.cs`
  ...
  projection plus flattened WASAPI capture/playback fields consumed by
  `AutomationSnapshot`.
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.AvSync.cs`
  owns live A/V sync drift and encoder correction projection plus final A/V
  sync projection-to-`AutomationSnapshot` field flattening.
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.CaptureCommands.cs`
  ...
  last-error projection inputs consumed by `AutomationSnapshot`, plus final
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.CaptureFormat.cs`
  ...
  by `AutomationSnapshot`, plus final capture-format flattening.
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.CaptureFormat.HdrRequest.cs`
  owns HDR activation and auto-downgrade projection inputs and final field
  flattening.
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.CaptureFormat.Actual.cs`
  owns actual capture dimensions and frame-rate projection inputs and final
  field flattening.
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.CaptureFormat.Negotiated.cs`
  owns negotiated capture dimensions, frame-rate, pixel format, and media
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.CaptureTransport.cs`
  ...
  frame-ledger projection consumed by `AutomationSnapshot`, plus final capture
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.CaptureCadence.cs`
  ...
  `AutomationSnapshot`, plus final source capture cadence
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.VisualCadence.cs`
  ...
  consumed by `AutomationSnapshot`, plus final visual cadence and center-crop
  visual cadence projection-to-`AutomationSnapshot` field flattening.
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.Mjpeg.cs`
  ...
  queue, and failure projection-to-`AutomationSnapshot` field flattening.
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.FlashbackPlayback.cs`
  ...
  owns playback event, cadence, PTS-cadence, and A/V drift projection plus
  flattened timing fields,
  `AutomationDiagnosticsHub.SnapshotProjection.FlashbackPlayback.Decode.cs`
  owns seek-cap/decode timing projection plus flattened decode fields, and
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.RecordingOutput.cs`
  ...
  `AutomationSnapshot`, plus final recording backend and output
  projection-to-`AutomationSnapshot` field flattening.
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.SourceSignal.cs`
  also owns final source projection flattening orchestration plus source
  dimensions, frame-rate, HDR, video/audio format, firmware, input, USB, HDCP,
  and raw timing field flattening.
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.TimelineProjection.Core.cs`
  owns timestamp, observed capture/preview FPS, encoder video queue depth/drop,
  and capture cadence timeline projection.
...
- `CaptureService.MicrophoneMonitor.cs` owns microphone-monitor shared state
  and mic-level event projection.
- `CaptureService.MicrophoneMonitor.Update.cs` owns the public monitor update
  transaction and preview-time Flashback mic writer attachment.
- `CaptureService.MicrophoneMonitor.Disposal.cs` owns mic writer-detach and
  capture disposal cleanup.
- `CaptureService.MicrophoneMonitor.Restart.cs` owns post-recording mic
  monitor restart and Flashback writer reattachment.
...
- `CaptureService.TransitionExecution.cs` owns transition serialization,
  transition-state entry, steady-state resolution, fault publication, and
  transition-lock release. `CaptureService.Coordination.cs` owns steady-state
  input sampling, cleanup/disposal state helpers, current-state projection, and
...
- `CaptureService.FlashbackState.cs` owns Flashback public state and segment
  access.
- `CaptureService.FlashbackEnable.cs` owns Flashback enable/disable transition
  gating.
- `CaptureService.FlashbackRestart.cs` owns Flashback restart entry points and
  committed restart orchestration after preview backend teardown.
...
- `CaptureService.FlashbackEncoderSettings.cs` owns active encoding-setting
  application, encoder setting cycles, and rollback after failed Flashback
  buffer cycles.
- `CaptureService.FlashbackRecordingFormat.cs` owns recording-format changes
  and rollback after failed Flashback buffer cycles.
...
- `CaptureService.FlashbackExportProgress.cs` owns Flashback export progress
  forwarding/normalization and force-rotate fallback counters.
...
- `CaptureService.FlashbackExportOperations.cs` owns Flashback export entry
  points and routing into backend snapshot, range-resolution, and shared core
  owners.
- `CaptureService.FlashbackExportBackendSnapshot.cs` owns lock-scoped backend
  snapshotting plus session/backend lock release before native export.
- `CaptureService.FlashbackExportRangeResolution.cs` owns range and last-N
...
- `CaptureService.FlashbackExportForceRotate.cs` owns live-edge force-rotate
  export preparation: failure/committed-pending outcomes, timeout fallback
  segment discovery, and related diagnostics/logging.
- `CaptureService.FlashbackExportRequestPreparation.cs` owns shared export
  request assembly: active-file fallback, `FlashbackExportRequest`
  construction, throttle-provider wiring, and partial-fallback result marking.
...
- `CaptureService.FlashbackRecording.cs` owns Flashback recording backend
  ...
  owns Flashback recording session-context construction, codec selection, GPU
  handle handoff, and HDR guardrails.
  `CaptureService.FlashbackRecording.FrameRate.cs` owns delivered-cadence
  frame-rate rational preservation/inference.
  `CaptureService.FlashbackRecording.SnapshotCompatibility.cs` owns legacy
  Flashback export verification/downgrade snapshot fields.
...
- `CaptureService.HealthSnapshotCaptureCadence.cs` owns source-cadence metric
  projection and its health field record for health snapshots.
...
- `CaptureService.HealthSnapshotFlashbackBackend.Queues.cs` owns live Flashback
  audio/video queue, force-rotate, backpressure, and GPU queue field projection
...
- `CaptureService.PreviewStart.cs` owns the video-preview start transition
  entry point and sequencing. `CaptureService.PreviewStart.Recycle.cs` owns
  preview pipeline and Flashback backend recycle decisions before start.
  `CaptureService.PreviewStart.FastPath.cs` owns retained-backend fast-path
  reattachment, and `CaptureService.PreviewStart.FreshPipeline.cs` owns fresh
  UVC startup, preview-start rollback, and fresh preview backend startup
  ordering.
...
- `CaptureService.RecordingIntegrity.cs` owns active recording integrity backend
  ...
  `RECORDING_INTEGRITY` log rendering; `.SummaryFields.cs` owns normalized
  video/audio summary handoff fields; `.SummaryEvaluation.cs` owns status,
  reason, and audio-status classification; `.Counters.cs` owns video/backend
  counter capture and baseline deltas; `.Audio.cs` owns audio counter capture
  and baseline deltas.
- `CaptureService.RecordingLifecycle.cs` owns public recording start
  ...
  resolution plus LibAv and Flashback `RecordingContextRequest` assembly.
  ...
  standard LibAv recording startup sequencing;
  `CaptureService.RecordingStartLibAv.VideoCapture.cs` owns standard LibAv
  video-capture reuse/creation, source-reader compatibility checks, preview
  sink/shared-device handoff, and video pipeline installation; and
...
- `CaptureService.RecordingFinalizeLibAvBackend.cs` owns standard LibAv
  ...
  cancellation throws.
- `CaptureService.RecordingFinalizeLibAvVideoBoundary.cs` owns standard LibAv
  unified-video recording stop, source-reader boundary diagnostics, and
  boundary-stop result capture. `CaptureService.RecordingFinalizeLibAvSink.cs`
  owns WASAPI recording sink detach, microphone capture disposal before sink
  stop, LibAv sink normal/emergency stop, sink disposal, and LibAv drain task
  tracking. `CaptureService.RecordingFinalizeLibAvIdlePreview.cs` owns
  inactive-preview teardown after recording, including deferred unified-video
...
- `FlashbackBufferManager.Lifecycle.cs` owns initialization, segment extension setup, disposal, and disposed-state guards. `FlashbackBufferManager.RecoveryPreserve.cs` owns recovery-preserve state and marker files.
- `FlashbackBufferManager.SegmentQueries.cs` owns segment path lookup,
  range selection, and start-PTS lookup. `FlashbackBufferManager.SegmentPathSafety.cs`
  owns session-directory path safety checks. `FlashbackBufferManager.SegmentStatus.cs`
...
- `FlashbackPlaybackController.DecoderFiles.cs` owns decoder creation, active file identity, file open checks, and shared decoder close/open identity transitions.
- `FlashbackPlaybackController.DecoderCleanup.cs` owns best-effort decoder file close handling, held-frame release during teardown, decoder close/dispose timing, and cleanup telemetry.
- `FlashbackPlaybackController.DecoderReopen.cs` owns active fMP4 reopen
  retry, keyframe-reopen recovery, and near-live reopen guards.
- `FlashbackPlaybackController.DecoderAdjacentSegmentSeek.cs` owns
  adjacent-segment seek fallback policy, segment-start probing, segment switch
  telemetry, and adjacent-seek failure handling.
...
- `FlashbackPlaybackController.Lifecycle.cs` owns initialize/update component
  references, lifecycle/dispose state, and dispose.
- `FlashbackPlaybackController.PreviewDetachLifecycle.cs` owns
  preview-detach cleanup, failed-stop detach timeout state, deferred preview
  reattach state, and deferred reattach retry scheduling.
...
- `FlashbackPlaybackController.CommandCoalescing.cs` owns seek/scrub coalesced command admission.
- `FlashbackPlaybackController.CommandCoalescingSlots.cs` owns seek/scrub
  coalescing slot state, queued-position resolution, and queued-slot barriers.
- `FlashbackPlaybackController.CommandControlYieldPolicy.cs` owns
  playback-thread control-yield peek policy for seek, scrub update, and
  pause-from-live commands.
- `FlashbackPlaybackController.CommandTelemetry.cs` owns command status
  counters, pending-command accounting, active-command timing, and queue command
  telemetry bookkeeping.
- `FlashbackPlaybackController.CommandMetrics.cs` owns the public read-only
  projection for command counters, command queue latency, command timestamps,
  last command failure, and playback-thread liveness.
...
- `FlashbackPlaybackController.ThreadLoop.cs` owns `PlaybackThreadEntry`,
  command dequeue/waiting, cancellation exits, and continuous-playback pacing
  handoff.
- `FlashbackPlaybackController.ThreadCommandDispatch.cs` owns playback-thread
  active-command telemetry, command-complete logging, `Stop` handling, and the
  dispatch switch to playback-thread command handlers.
- `FlashbackPlaybackController.ThreadExit.cs` owns playback-thread exit
  transactions: prebuffer release, timer-resolution release, command-channel
  completion/drain, thread/CTS ownership clearing, and deferred preview attach.
...
- `FlashbackPlaybackController.ThreadSeekScrubCommands.cs` owns playback-thread
  scrub begin/update command execution, including frozen valid-start sampling,
  scrub update coalescing, and scrub-display failure recovery.
- `FlashbackPlaybackController.ThreadEndScrubCommand.cs` owns playback-thread
  end-scrub resume, paused exact-resume target handling, end-scrub seek/reopen,
  playback audio prebuffer priming, and rendering resume ordering.
...
- `FlashbackPlaybackController.ThreadPauseCommand.cs` owns playback-thread
...
- `FlashbackPlaybackController.ThreadNudgeCommand.cs` owns playback-thread
...
- `FlashbackPlaybackController.ThreadCommands.cs` owns playback-thread
  go-live and stop command execution, including live-restore handoff and
  thread-local playback state reset.
- `FlashbackPlaybackController.ThreadLifecycle.cs` owns playback thread state
  fields and stop timeout policy.
- `FlashbackPlaybackController.ThreadStartLifecycle.cs` owns playback thread
  start/recovery and start-failure rollback.
- `FlashbackPlaybackController.ThreadStopLifecycle.cs` owns playback thread
  stop/cancel/join diagnostics and post-stop cleanup.
- `FlashbackPlaybackController.ThreadChannel.cs` owns playback-thread command
  channel capacity, channel state, bounded-channel recreation/completion, and
  abandoned-command draining.
- `FlashbackPlaybackController.ThreadCleanup.cs` owns playback-thread
  live-restore cleanup and playback CTS disposal warnings.
...
- `FlashbackPlaybackController.AudioMasterPacing.cs` owns audio-master pacing
  correction policy, delay-adjustment counter projection, and wall-clock
  sleep/spin pacing.
- `FlashbackPlaybackController.AudioMasterFallbacks.cs` owns audio-master
  ...
  suppression, and read-only fallback reason/drift/clock-age telemetry
  projection and updates.
- `FlashbackPlaybackController.PreviewFrames.cs` owns decoded frame
  preview-sink selection, submission telemetry, renderer calls, and held-frame
  handoff.
...
- `FlashbackPlaybackController.SeekDisplay.cs` owns seek/scrub keyframe display,
  keyframe seek/reopen retry, and file-PTS mapping for displayed seek frames.
...
- `FlashbackPlaybackController.PlaybackSegmentEdges.cs` owns segment-edge
  routing decisions, write-head waits, and active fMP4 reopen handoff.
- `FlashbackPlaybackController.PlaybackSegmentSwitch.cs` owns the next-segment
  switch transaction: next-file probing, segment switch counters, decoder
  reopen/open, seek target clamping, post-switch audio gate, and PTS cadence
  baseline reset.
- `FlashbackPlaybackController.DecoderSegmentReopen.cs` owns active fMP4
  reopen mechanics during segment-edge handling.
- `FlashbackPlaybackController.PlaybackTiming.cs` owns frame-rate resolution,
  ...
  and rolling playback cadence metric updates.
- `FlashbackPlaybackController.PlaybackPtsCadence.cs` owns decoded PTS cadence
  state, read-only projection, tracking, mismatch telemetry, and
  cadence-baseline reset.
- `FlashbackPlaybackController.PlaybackSoftwareBudget.cs` owns
  software-decode budget detection, decoder hardware-acceleration status
  refresh, over-budget snap telemetry, and the recovery handoff to
  `FlashbackPlaybackController.PlaybackLiveRecovery.cs`.
- `FlashbackPlaybackController.MarkersState.cs` owns in/out marker state, file-PTS projection, and recovery restore.
- `FlashbackPlaybackController.Markers.cs` owns the marker command API, marker normalization, invalid-range clearing, and out-point pause checks.
...
- `FlashbackPlaybackController.PlaybackCadenceMetrics.cs` owns cadence summary
  DTO construction, percentile math, and low-FPS derivation.
- `FlashbackPlaybackController.PlaybackDecodeMetrics.cs` owns decode summary
  DTO construction and decode timing percentile projection.
- `FlashbackPlaybackController.MetricsCollection.cs` owns private playback
  metric counters, read-only counter projection, and cadence sample rings.
- `FlashbackPlaybackController.MetricReset.cs` owns playback metric reset
  across playback, command, audio-master, and decode metric fields.
- `FlashbackPlaybackController.SeekCapTelemetry.cs` owns seek-cap telemetry
  state, read-only projection, decoder seek forwarding, and
  forward-decode-cap hit logging.
- `FlashbackPlaybackController.PlaybackDecodeMetricsCollection.cs` owns
  playback decode duration rings, max decode phase timing state, read-only max
  decode projection, decode timing wrappers, and dominant decode phase
  resolution.
- `FlashbackEncoderSink.Startup.cs` owns buffer session creation, encoder initialization, active-segment setup, PTS continuation, background task startup, and start-transaction orchestration.
- `FlashbackEncoderSink.StartupQueues.cs` owns video/audio/microphone/GPU queue allocation, hardware queue enablement, queue capacity publication, and CPU-encoding warning logs.
- `FlashbackEncoderSink.StartupRollback.cs` owns start-failure logging, partially initialized queue completion, state rollback, CTS/encoder cleanup, and generated-segment cleanup.
- `FlashbackEncoderSink.StartupPolicy.cs` owns session validation, frame-rate fallback/clamping, high-resolution queue capacity policy, and hardware-vs-CPU queue capacity resolution.
- `FlashbackEncoderSink.DiagnosticsReset.cs` owns counter resets, queue-depth resets, rejection-reason clears, video diagnostics reset, and segment-start byte reset.
- `FlashbackEncoderSink.RecordingAccounting.cs` owns saturated PTS conversion, non-negative byte/duration math, and best-effort eviction resume fallback.
- `FlashbackEncoderSink.Options.cs` owns encoder option construction, segment extension policy, transport container selection, and session frame-rate rational validation.
- `FlashbackEncoderSink.SessionContext.cs` owns recording-to-Flashback session mapping, recording-format codec mapping, split-encode wire mapping, and recording frame-rate argument parsing.
- `FlashbackEncoderSink.FileSessionHelpers.cs` owns best-effort file-size probing and generated session ID formatting.
- `FlashbackEncoderSink.PacketBuffers.cs` owns ArrayPool packet buffer rent/return helpers, leased video packet disposal, best-effort video packet cleanup, and GPU texture release helpers.
- `FlashbackEncoderSink.PacketTypes.cs` owns video/audio/GPU packet DTOs and video enqueue result classification.
- `FlashbackEncoderSink.VideoQueueSubmission.cs` owns video/GPU queue admission transactions, queue-full classification, and producer wakeup signaling.
- `FlashbackEncoderSink.VideoQueueSubmission.Guards.cs` owns video/GPU enqueue lifecycle guards and producer input rejection reasons.
- `FlashbackEncoderSink.VideoQueueSubmission.Writers.cs` owns video/GPU TryWrite depth accounting, max-depth updates, and failed-write depth rollback.
- `FlashbackEncoderSink.VideoQueueSubmission.Rejections.cs` owns video/GPU rejection counters, last-reason state, and throttled queue rejection logs.
- `FlashbackEncoderSink.Queues.cs` owns queue completion/signaling, shared queue-depth accounting, cancellation waits, and failure notification.
- `FlashbackEncoderSink.AudioQueueSubmission.cs` owns audio/microphone queue admission, force-rotate audio queue guard policy, backlog eviction accounting, audio-drop diagnostics, and audio channel writes.
...
- `FlashbackEncoderSink.PacketDrain.Video.cs` owns bounded video/GPU packet drains, frame-size defense, queue-depth accounting, and video packet cleanup.
- `FlashbackEncoderSink.PacketDrain.Audio.cs` owns bounded audio/microphone packet drains, queue-depth accounting, encoder audio submission, and pooled audio buffer return.
- `FlashbackEncoderSink.EncodingProgress.cs` owns encoder PTS resolution, latest-PTS and disk-byte refresh, segment-rotation triggering, and frame-encoded event dispatch.
...
- `FlashbackEncoderSink.ForceRotate.cs` owns export force-rotate state/status projections and idle waits.
- `FlashbackEncoderSink.ForceRotateRequests.cs` owns export force-rotate request admission, request publication, timeout/cancellation result classification, and committed-pending grace handling.
- `FlashbackEncoderSink.ForceRotateLifecycle.cs` owns pending-request cancellation, empty completion on stop/dispose/failure, and force-rotate drain abort policy.
- `FlashbackEncoderSink.ForceRotateRequest.cs` owns the `ForceRotateRequest` state machine, commit transition, cancellation, and completion result publication.
...
- `FlashbackEncoderSink.Inputs.Video.cs` owns raw/lease/GPU video enqueue entry points, video/GPU rejection guards, frame-size validation, and texture AddRef ownership.
- `FlashbackEncoderSink.Inputs.Audio.cs` owns audio/microphone enqueue entry points, force-rotate audio rejection guards, and hot WASAPI writer adapters.
...
- `FlashbackEncoderSink.Recording.State.cs` owns recording PTS boundary state, active-recording projection, and begin-recording availability checks.
- `FlashbackEncoderSink.Recording.Start.cs` owns the `IRecordingSink.StartAsync` adapter, recording begin validation, eviction-pause handoff, active-state publication, and start rollback.
- `FlashbackEncoderSink.Recording.End.cs` owns recording end rejection/failure/success results, end-PTS capture, eviction resume, PTS clamping, and ready logging.
- `FlashbackEncoderSink.RuntimeState.Counters.cs` owns public frame/audio/disk counters, drop counters, rotation-failure counts, and the frame-encoded event surface.
- `FlashbackEncoderSink.RuntimeState.QueueMetrics.cs` owns queue-depth/capacity/max-depth projections, queue rejection summaries, GPU queue projections, and video queue latency/backpressure metrics.
- `FlashbackEncoderSink.RuntimeState.Status.cs` owns encoding failure status, audio/microphone enablement, fatal-error callback registration, encoder format summaries, HDR P010 projection, and encoding completion task exposure.
...
- `Sussudio/MainWindow.PreviewRuntimeSnapshot.cs` owns the stable automation
  ...
  owns read-only preview runtime snapshot construction orchestration.
...
- `tests/Sussudio.Tests/MainWindow.FlashbackOwnership.Helpers.cs` owns the
  shared source reader for the split `MainWindow.Flashback.*.cs` adapter family.
...
- `Sussudio/Controllers/Flashback/FlashbackScrubInteractionController.cs` owns active
  ...
  updates. `MainWindow.Flashback.Scrub.cs` is the XAML-facing adapter.
...
- `Sussudio/Controllers/Flashback/FlashbackCommandController.cs` owns Flashback command
  ...
  enable-toggle rollback, and apply/restart. `MainWindow.Flashback.Commands.cs`
...
- `Sussudio/Controllers/Flashback/FlashbackSettingsBindingController.cs` owns Flashback
  ...
  `MainWindow.Flashback.Settings.cs` is the XAML-facing settings adapter; enable
...
- `Sussudio/Controllers/Flashback/FlashbackPollingController.cs` owns Flashback status
  and playback-position polling timers. `MainWindow.Flashback.Polling.cs` is the
...
- `Sussudio/ViewModels/MainViewModel.*.cs` for root presentation state and
  ...
  and nudge command routing. `MainViewModel.FlashbackPlaybackAutomation.cs`
...
- `tools/Common/DiagnosticSessionRunContext.cs` owns diagnostic-session core mutable run infrastructure:
  bootstrap, actions, warnings, samples, run state, command channel, and
  scenario cancellation source.
- `tools/Common/DiagnosticSessionRunContext.InitialSnapshot.cs` owns diagnostic-session initial snapshot state:
  unknown-state initialization, initial snapshot capture, and known-state
  publication.
- `tools/Common/DiagnosticSessionRunContext.LiveState.cs` owns diagnostic-session live-state handoff:
  live breadcrumb writer storage, live path publication, normal live writes, and
  sampling live writes.
- `tools/Common/DiagnosticSessionRunContext.Lifetime.cs` owns diagnostic-session run context disposal:
  idempotent command-channel and scenario cancellation source cleanup.
...
- `tools/Common/DiagnosticSessionRunExecution.Completion.cs` owns the
  ...
  write.
- `tools/Common/DiagnosticSessionRunExecution.CompletionContext.cs` owns the
  diagnostic-session completion context handoff consumed by the post-cleanup
  completion phase.
- `tools/Common/DiagnosticSessionRunExecution.ResultBuildRequest.cs` owns the
  diagnostic-session result-build request mapping from completion evidence and
...
- `tools/Common/DiagnosticSessionScenarioPhaseContext.cs` owns the explicit
  scenario phase input handoff from run context construction into the phase
  runner.
- `tools/Common/DiagnosticSessionScenarioPhaseResult.cs` owns the immutable
  scenario phase result handoff consumed by completion.
- `tools/Common/DiagnosticSessionScenarioPhaseState.cs` owns the mutable
  in-flight scenario phase state that setup, startup, sampling, and completion
  update before it is projected into the result.
...
- `tools/Common/DiagnosticSessionBackgroundTasks.cs` owns diagnostic-session
  ...
  registered scenario completion, plus the registration record used to preserve
  await order.
...
- `tools/Common/DiagnosticSessionBackgroundTasks.FaultDrain.cs` owns
  interrupted background-task drain orchestration, generic scenario-task warning
  collection, and the drain result handoff.
...
- `tools/Common/AutomationSnapshotFormatter.cs` owns the top-level shared
  ...
  Flashback queue-latency, backpressure, failure, and GPU queue text.

...
- `FlashbackPlaybackController.PlaybackFrames.cs` owns continuous playback frame
  ...
  failure accounting, frame-skip catch-up, decode-error snap, near-live snap,
  and playback failure recovery back to live state.

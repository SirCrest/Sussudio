...
| Flashback | `FlashbackPlaybackController.cs`, `FlashbackPlaybackController.Markers.cs`, `FlashbackPlaybackController.PositionMapping.cs`, `FlashbackEncoderSink.cs`, `FlashbackExporter.cs` | playback core, marker owner, position/file-PTS mapping, buffer, encoder, export modules |

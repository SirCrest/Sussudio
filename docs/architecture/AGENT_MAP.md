...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.ScreenshotRequests.cs` owns
  ...
  and error result construction. `D3D11PreviewRenderer.ScreenshotStaging.cs`
  owns staging-texture reuse and resize, while
  ...
  completion and encode-gate release.

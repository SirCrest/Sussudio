...
| Capture runtime | `Sussudio/Services/Capture/CaptureService.cs`, `CaptureService.Audio.cs`, `CaptureService.Coordination.cs`, `CaptureService.Failures.cs`, `CaptureService.PreviewPipeline.cs`, `CaptureService.Probes.cs`, `CaptureService.Snapshots.cs`, `CaptureService.Telemetry.cs` | lifecycle owner, audio owner, transition/disposal owner, failure owner, preview pipeline owner, probe owner, snapshot builder, telemetry owner, resource managers |

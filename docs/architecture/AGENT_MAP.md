...
| Capture runtime | `Sussudio/Services/Capture/CaptureService.cs`, `CaptureService.Audio.cs`, `CaptureService.Probes.cs`, `CaptureService.Snapshots.cs`, `CaptureService.Telemetry.cs` | transition state machine, audio owner, probe owner, snapshot builder, telemetry owner, resource managers |

...
- `CaptureService.FlashbackPreviewBackend.cs` owns Flashback preview backend
  ...
  teardown lock ordering, purge-policy resolution, service callback binding,
  cancellation-token choice, and preview backend disposal request construction.

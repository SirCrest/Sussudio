...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.cs` owns the renderer public
  ...
  dispatch, frame-latency waitable swap-chain pacing, final drain, and
  renderer mode reset.

...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.SnapshotProjection.PreviewD3D.cs`
  owns D3D preview swap-chain and submitted/rendered/dropped frame projection
  consumed by `AutomationSnapshot`.

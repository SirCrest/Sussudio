...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.Resources.cs` owns D3D
  ...
  renderer-owned device fallback, VideoProcessor input texture resources, HDR
  shader input resources, top-level cleanup orchestration, video-processor

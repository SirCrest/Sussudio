...
- `tools/Common/DiagnosticSessionResultBuilder.cs` owns diagnostic-session
  ...
  handoff created by `DiagnosticSessionRunExecution.cs` and consumed by the
  result builder. Keep `summary.json` field shape stable in the builder family.

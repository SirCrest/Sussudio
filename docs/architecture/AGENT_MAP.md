...
| Preview rendering | `D3D11PreviewRenderer.cs`, `D3D11PreviewRenderer.FrameTypes.cs`, `D3D11PreviewRenderer.Submission.cs`, `D3D11PreviewRenderer.Rendering.cs`, `D3D11PreviewRenderer.Resources.cs`, `D3D11PreviewRenderer.PendingFrames.cs`, `D3D11PreviewRenderer.Metrics.cs`, `D3D11PreviewRenderer.ScreenshotCapture.cs`, `D3D11PreviewRenderer.ShaderSources.cs` | renderer host, pending-frame and metrics model types, public frame submission entry points, render loop/draw paths, D3D resources and swap-chain binding, pending-frame queue/signaling, present/latency metrics, screenshot capture, shader source, timing models |

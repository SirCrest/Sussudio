...
- `CaptureService.FlashbackExportOperations.cs` owns Flashback export entry
  points and operation-specific range resolution before the shared export core
  runs.

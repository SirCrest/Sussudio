...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.Submission.cs` owns raw,
  ...
  ownership, pending-frame construction, pending-frame queue control,
  frame-ready signaling, and `IPreviewFrameQueueControl`.

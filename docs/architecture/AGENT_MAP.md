...
| Recording models | `Sussudio/Models/Recording/RecordingModels.cs` | consolidated recording model surface for media format display/equality/HDR helper policy, encoder support, integrity summary, pipeline queue options, and recording byte stats |

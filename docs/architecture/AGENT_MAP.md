...
- `FlashbackPlaybackController.ThreadLifecycle.cs` owns playback thread state,
  CTS lifetime, stop timeouts, thread start/recovery, and join/cancel
  diagnostics.

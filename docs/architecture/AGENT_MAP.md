...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.Alerts.cs` owns alert
  ...
  Flashback playback alert orchestration, Flashback playback performance alert
  routing, frame-submission failure alerts, plus signal alert orchestration.

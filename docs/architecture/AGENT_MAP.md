...
- `tests/Sussudio.Tests/CaptureService.HealthSnapshots.Tests.cs` owns
  ...
  capture cadence, source telemetry, MJPEG, Flashback buffer/backend, Flashback
  export, Flashback playback, and recording.

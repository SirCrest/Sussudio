...
| Capture cadence trackers | `Sussudio/Services/Capture/FrameFingerprintCadenceTracker.cs`, `Sussudio/Services/Capture/VisualCadenceTracker.cs`, `Sussudio/Services/Capture/VisualCadenceTracker.Metrics.cs` | source-packet duplicate cadence tracking, decoded-frame luma sampling and crop comparison, visual-cadence metrics DTO construction/statistics/motion-confidence projection |
...
- `FrameFingerprintCadenceTracker.cs` owns source-packet hash cadence tracking
  and duplicate-pattern reporting.

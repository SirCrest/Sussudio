...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.Alerts.cs` owns alert
  ...
  group routing, Flashback playback alert orchestration, Flashback playback
  performance alert routing, and frame-submission failure alerts.
...
- `Sussudio/Services/Automation/AutomationDiagnosticsHub.Evaluation.cs` owns
  performance scoring, shared alert-detail formatting, and health classifiers
...
- `LibAvEncoder.VideoSubmission.cs` owns CPU packed-frame submission,
  ...
  attachment/removal, and video packet drains.

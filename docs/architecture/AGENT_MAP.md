...
- `CaptureService.FlashbackExportProgress.cs` owns Flashback export entry
  points, segment selection, live-export throttling, progress forwarding, and
  export diagnostics state.

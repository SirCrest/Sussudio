...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.PresentCadenceMetrics.cs`
  ...
  owns renderer metric record structs plus shared ring-copy, timing-summary,
...
- `FlashbackEncoderSink.PacketBuffers.cs` owns video/audio/GPU packet DTOs, video enqueue result classification, ArrayPool packet buffer rent/return helpers, leased video packet disposal, best-effort video packet cleanup, and GPU texture release helpers.

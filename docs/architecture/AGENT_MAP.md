...
| Capture fan-out | `Sussudio/Services/Capture/UnifiedVideoCapture.cs`, `UnifiedVideoCapture.Metrics.cs` | shared preview/recording/Flashback source session and frame routing, diagnostic metric/snapshot projection |

...
- `Sussudio/Controllers/Flashback/FlashbackMarkerPresentationController.cs` owns
  ...
  text formatting. `Sussudio/MainWindow.Flashback.Presentation.Markers.cs` wires marker

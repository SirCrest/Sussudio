...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.Metrics.cs` owns present
  ...
  `D3D11PreviewRenderer.MetricTypes.cs` owns renderer metric record structs plus
  shared ring-copy, timing-summary, tick-to-ms, and render-stage validation
  helpers.

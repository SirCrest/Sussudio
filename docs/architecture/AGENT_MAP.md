...
- `CaptureService.HealthSnapshotFlashbackPlayback.cs` owns Flashback playback
  ...
  playback cadence metric sampling, decode timing and max-phase metric
  sampling, audio-master pacing/fallback sampling, playback command telemetry
  sampling, and each matching private field record.

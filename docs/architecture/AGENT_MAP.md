...
- `CaptureService.FlashbackRecording.cs` owns Flashback recording backend
  ...
  frame-rate rational preservation/inference. `CaptureService.FlashbackRecording.cs`
  also owns legacy Flashback export verification/downgrade snapshot fields.

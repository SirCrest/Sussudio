...
| Capture runtime | `Sussudio/Services/Capture/CaptureService.cs`, `CaptureService.Initialization.cs`, `CaptureService.AudioPreviewLifecycle.cs`, `CaptureService.AudioInputSwitching.cs`, `CaptureService.MicrophoneMonitor.cs`, `PreviewAudioGraphResources.cs`, `CaptureRecordingBackendResources.cs`, `CaptureVideoPipelineResources.cs`, `CaptureService.Cleanup.cs`, `CaptureService.TransitionExecution.cs`, `CaptureService.ResourceRelease.cs`, `CaptureService.DeferredCleanup.cs`, `CaptureService.Failures.cs`, `CaptureService.FailureCleanup.cs`, `CaptureService.FlashbackBackendFailureCleanup.cs`, `CaptureService.FlashbackState.cs`, `CaptureService.FlashbackEnable.cs`, `CaptureService.FlashbackRestart.cs`, `CaptureService.FlashbackSettings.cs`, `CaptureService.FlashbackAudioInputs.cs`, `CaptureService.FlashbackPreviewBackend.cs`, `CaptureService.FlashbackBufferCycle.cs`, `CaptureService.FlashbackExportDiagnostics.cs`, `CaptureService.FlashbackExportProgress.cs`, `CaptureService.FlashbackExportFailureClassification.cs`, `CaptureService.FlashbackExportOperations.cs`, `CaptureService.FlashbackExportBackendSnapshot.cs`, `CaptureService.FlashbackExportRangeResolution.cs`, `CaptureService.FlashbackExportCore.cs`, `CaptureService.FlashbackExportForceRotate.cs`, `CaptureService.FlashbackExportRequestPreparation.cs`, `CaptureService.FlashbackExportPlanning.cs`, `CaptureService.FlashbackRecording.cs`, `CaptureService.HealthSnapshots.cs`, `CaptureService.HealthSnapshotAssembler.cs`, `CaptureService.HealthSnapshotFlashbackBackend.cs`, `CaptureService.HealthSnapshotSourceTelemetry.cs`, `CaptureService.HealthSnapshotFlashbackExport.cs`, `CaptureService.HealthSnapshotFlashbackPlayback.cs`, `CaptureService.HealthSnapshotFlashbackPlayback.State.cs`, `CaptureService.HealthSnapshotRecording.cs`, `CaptureService.HealthSnapshotRecordingActiveBackend.cs`, `CaptureService.PreviewStart.cs`, `CaptureService.PreviewAudioGraph.cs`, `CaptureService.PreviewStop.cs`, `CaptureService.PreviewReuse.cs`, `CaptureService.PreviewDisposal.cs`, `CaptureService.VideoPipelineLifecycle.cs`, `CaptureService.Probes.cs`, `CaptureService.RecordingIntegrity.cs`, `CaptureService.RecordingIntegrity.Summary.cs`, `CaptureService.RecordingIntegrity.SummaryFields.cs`, `CaptureService.RecordingIntegrity.SummaryEvaluation.cs`, `CaptureService.RecordingIntegrity.Counters.cs`, `CaptureService.RecordingIntegrity.Audio.cs`, `CaptureService.RecordingLifecycle.cs`, `CaptureService.RecordingStartContext.cs`, `CaptureService.RecordingStartFlashback.cs`, `CaptureService.RecordingStartLibAv.cs`, `CaptureService.RecordingStopLifecycle.cs`, `CaptureService.RecordingFinalizeFlashbackBackend.cs`, `CaptureService.RecordingFinalizeLibAvBackend.cs`, `CaptureService.RecordingFinalizeLibAvPreviewRestore.cs`, `CaptureService.RecordingFinalizeFlashback.cs`, `CaptureService.RecordingRollback.cs`, `CaptureService.RuntimeSnapshots.cs`, `CaptureService.RuntimeSnapshotAssembler.cs`, `CaptureService.RuntimeSnapshotIngestAudio.cs`, `CaptureService.RuntimeSnapshotReaderTransport.cs`, `CaptureService.RuntimeSnapshotHdrPipeline.cs`, `CaptureService.RuntimeSnapshotSourceTelemetry.cs`, `CaptureService.RuntimeSnapshotRecordingIntegrity.cs`, `CaptureService.Snapshots.cs`, `CaptureService.Telemetry.cs`, `CaptureService.CaptureFormatTelemetry.cs` | service state and construction owner, initialization owner, audio preview lifecycle/volume/event owner, live audio input switching owner, microphone monitor state/event/disposal/update/restart owner, preview audio resource owner, active recording backend resource owner, video pipeline resource owner, cleanup/disposal owner, transition transaction/state-sampling owner, resource release helper owner, deferred cleanup owner, failure callback and failure-telemetry owner, fatal cleanup launch owner, Flashback backend failure cleanup/device-lost owner, Flashback public state owner, Flashback enable/disable transition owner, Flashback restart orchestration owner, Flashback settings/buffer/GPU/format/encoder-cycle owner, Flashback audio input restoration owner, Flashback preview backend startup/disposal owner, Flashback buffer cycle coordination owner, Flashback export diagnostics lifecycle owner, Flashback export progress/fallback telemetry owner, Flashback export failure taxonomy, Flashback export entry/routing owner, Flashback export backend snapshot/lock handoff owner, Flashback export range-resolution owner, Flashback export core lifetime owner, Flashback export force-rotate preparation owner, Flashback export request assembly owner, Flashback export segment-planning/throttle owner, Flashback recording backend/capability/session-context/frame-rate owner, health snapshot sampler with capture cadence/MJPEG projections, health snapshot DTO assembler and handoff owner, Flashback backend and queue health projection, source telemetry health projection, Flashback export health projection, Flashback playback health projection, recording health orchestration, active recording backend health projection, preview start/recycle/fast-path/fresh-pipeline owner, preview audio graph owner, preview disposal transition owner, video pipeline lifecycle owner, probe owner, recording integrity active-backend resolver, integrity summary DTO/log owner, normalized integrity summary input owner, integrity status/reason evaluation owner, integrity counter DTO/capture, audio integrity DTO/capture, recording start transition/router, rollback-state holder, and recording outcome-state owner, recording start context request owner, Flashback recording start owner, LibAv recording start/video/audio startup owner, recording stop transition/finalization router owner, Flashback recording backend finalization and reconciliation owner, LibAv recording finalization/video-boundary/sink/idle-preview owner, LibAv recording preview-restore owner, Flashback recording export-finalize and boundary snapshot owner, transient recording rollback owner, runtime snapshot sampler, runtime snapshot DTO assembler, runtime ingest/audio projection, runtime reader/transport projection, runtime HDR/encoder pipeline projection, runtime source-telemetry projection, runtime recording-integrity projection, diagnostics compatibility and shared snapshot utilities/recording stats/format/observed frames/A/V sync/source telemetry snapshot policy, source telemetry polling owner, capture-format and observed pixel telemetry owner, resource managers |
...
- `CaptureService.Cleanup.cs` owns explicit cleanup transitions,
  ...
  segment preservation when cleanup finalization fails, and calls to
  TransitionExecution cleanup and disposed-state helpers.
- `CaptureService.TransitionExecution.cs` owns transition serialization,
  ...
  current-state projection, and initialization/disposal guards.

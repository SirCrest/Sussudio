...
| Audio capture | `Sussudio/Services/Audio/WasapiAudioCapture.cs`, `WasapiAudioCapture.Fanout.cs`, `WasapiAudioCapture.Conversion.cs` | WASAPI device lifecycle/capture thread, sink/playback/hot writer fan-out, and f32le 48 kHz stereo conversion/resampling helpers |

...
- `FlashbackPlaybackController.Metrics.cs` owns playback diagnostic counters
  excluding command/thread telemetry projection, audio-master projection,
  decoded-PTS cadence projection, max decode timing projection, and seek-cap

...
- `CaptureService.Cleanup.cs` owns explicit cleanup transitions,
  ...
  segment preservation when cleanup finalization fails, calls to
  TransitionExecution cleanup and disposed-state helpers, best-effort semaphore

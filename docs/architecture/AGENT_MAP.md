...
- `Sussudio/Services/Preview/D3D11PreviewRenderer.Resources.cs` owns D3D
  ...
  recreation, output-view/RTV reuse, color-space updates, and processor-resource
  teardown. Family-specific teardown stays next to creation: VideoProcessor input texture
